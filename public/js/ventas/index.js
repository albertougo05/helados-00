...
/***/ "./resources/js/print/drvImpresion.js":
/*!********************************************!*\
  !*** ./resources/js/print/drvImpresion.js ***!
  \********************************************/
...
/* harmony export */   "_drvImpresion": () => (/* binding */ _drvImpresion)
/* harmony export */ });
 ...
 * 
 */
var __getConfig = function __getConfig() {
  return {
    method: 'GET',
    cache: 'no-cache',
    mode: 'no-cors',
...
var _retornarSO = function _retornarSO() {
  var so = '';
  var navInfo = window.navigator.userAgent.toLowerCase();
...
var __getParametros = function __getParametros(queImp, params) {
  var parametros = '?';

  switch (queImp) {
    case 'ticket_vta':
      parametros += "idcomp=".concat(params.idcomp, "&idsuc=").concat(params.idsuc, "&iduser=").concat(params.iduser, "&");
      parametros += "turnosuc=".concat(params.turnosuc, "&impres=").concat(params.impres, "&");
      parametros += "sisop=".concat(_retornarSO(), "&env=").concat(params.env);
      break;

    case 'cierre_caja':
      parametros += "sucursal_id=".concat(params.sucursal_id, "&");
      parametros += "cierre_id=".concat(params.cierre_id, "&impres=").concat(params.impres, "&");
      parametros += "sisop=".concat(_retornarSO(), "&env=").concat(params.env);
      break;

    case 'ingreso_stock':
      parametros += "sucursal_id=".concat(params.sucursal_id, "&comprob_id=").concat(params.comprob_id, "&");
      parametros += "impres=".concat(params.impres, "&");
      parametros += "sisop=".concat(_retornarSO(), "&env=").concat(params.env);
      break;

    case 'info_diario':
      parametros += "sucursal_id=".concat(params.sucursal_id, "&fecha=").concat(params.fecha, "&");
      parametros += "hora=".concat(params.hora, "&impres=").concat(params.impres, "&");
      parametros += "sisop=".concat(_retornarSO(), "&env=").concat(params.env, "&sucursal=").concat(params.sucursal);
      break;

    case 'movim_caja':
      parametros += "sucursal=".concat(params.sucursal, "&movnro=").concat(params.movim_nro, "&");
      parametros += "fechahora=".concat(params.fecha_hora, "&usuario=").concat(params.usuario, "&");
      parametros += "tipomovim=".concat(params.tipo_movim, "&turnonro=").concat(params.turno_nro, "&");
      parametros += "concepto=".concat(params.concepto, "&importe=").concat(params.importe, "&");
      parametros += "observac=".concat(params.observac, "&impres=").concat(params.impres, "&");
      parametros += "sisop=".concat(_retornarSO(), "&env=").concat(params.env);
      break;
  }
...
var __getUrl = function __getUrl(queImp, params) {
  var parametros = __getParametros(queImp, params);
...
var _drvImpresion = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(queImprime, params) {
    var url, config, resp;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = __getUrl(queImprime, params);
            config = __getConfig();
            _context.next = 4;
  ...
  return function _drvImpresion(_x, _x2) {
...
/***/ "./resources/js/turnos/formatMinutos.js":
/*!**********************************************!*\
  !*** ./resources/js/turnos/formatMinutos.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
function formatMinutos() {
  var numMin = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  return String(numMin).padStart(2, "0");
  ;
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (formatMinutos);

/***/ }),

/***/ "./resources/js/utils/MensajeAlerta.js":
/*!*********************************************!*\
  !*** ./resources/js/utils/MensajeAlerta.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MensajeAlerta),
/* harmony export */   "mensajeErrorEntendido": () => (/* binding */ mensajeErrorEntendido)
/* harmony export */ });
...
var MensajeAlerta = function MensajeAlerta() {
  var mensaje = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var icono = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "error";
...
var mensajeErrorEntendido = function mensajeErrorEntendido() {
  var mensaje = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
...
var masks = {
  ...
  cuatroCerosIzq: {
    ...
    commit: function commit(value, masked) {
      if (value !== '') masked._value = value.padStart(4, '0');
    }
  },
  ...
  ochoCerosIzq: {
    mask: /^\d+$/,
    commit: function commit(value, masked) {
      if (value !== '') masked._value = value.padStart(8, '0');
    }
  },
  // Mascar hora (00:00)
  hora: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (masks);
...
/***/ "./resources/js/utils/transformFechas.js":
/*!***********************************************!*\
  !*** ./resources/js/utils/transformFechas.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "_sumaRestaFecha": () => (/* binding */ _sumaRestaFecha),
/* harmony export */   "_validaFecha": () => (/* binding */ _validaFecha),
/* harmony export */   "englishToSpanish": () => (/* binding */ englishToSpanish),
/* harmony export */   "fechaActual": () => (/* binding */ fechaActual),
/* harmony export */   "horaActual": () => (/* binding */ horaActual),
/* harmony export */   "spanishToEnglish": () => (/* binding */ spanishToEnglish)
/* harmony export */ });
/* harmony import */ var _turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../turnos/formatMinutos */ "./resources/js/turnos/formatMinutos.js");
...
var englishToSpanish = function englishToSpanish() {
  var fecha = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

  if (fecha.length > 0) {
    var arrNums = fecha.split('-');
...
var spanishToEnglish = function spanishToEnglish() {
  var fecha = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
...
var fechaActual = function fechaActual() {
  ...
  if (format === 'es') {
    ...
    return "".concat(year, "-").concat(month, "-").concat(day); // English
  }
};
/**
...
var horaActual = function horaActual() {
  var _hora = new Date();

  return (0,_turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_0__["default"])(_hora.getHours()) + ':' + (0,_turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_0__["default"])(_hora.getMinutes());
};
/**
...
var _validaFecha = function _validaFecha() {
  var fecha = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
var _sumaRestaFecha = function _sumaRestaFecha(fecha) {
  var operador = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '+';
  var cantDias = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var format = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'en';
  var date = undefined;

  if (fecha === '') {
    // Poner fecha actual
    date = luxon__WEBPACK_IMPORTED_MODULE_1__.DateTime.now();
  } else {
    date = luxon__WEBPACK_IMPORTED_MODULE_1__.DateTime.fromISO(fecha); // debe ser formato 'en': '2023-07-31'
  }
...
/***/ "./resources/js/ventas/BuscarCliente.js":
/*!**********************************************!*\
  !*** ./resources/js/ventas/BuscarCliente.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BuscarCliente)
/* harmony export */ });
...
var BuscarCliente = /*#__PURE__*/function () {
  function BuscarCliente(idClienteSelec) {
    _classCallCheck(this, BuscarCliente);

    this.idClienteSelec = parseInt(idClienteSelec);
  }

  _createClass(BuscarCliente, [{
    key: "buscarMostrar",
    value: function buscarMostrar() {
      var _this = this;

      var _mostrarDatos = function _mostrarDatos(data) {
        var dir = document.querySelector('p#dataDir');
        dir.textContent = "Dirección: " + data.direccion;
        var loc = document.querySelector('p#dataLoc');
        loc.textContent = "Localidad: " + data.localidad;

        _this._actualizarDatosCli(data);
      };
      ...
      axios.get(_VENTA.pathBuscarCliente, options).then(function (data) {
    ...
    key: "_actualizarDatosCli",
    value: function _actualizarDatosCli(data) {
...
/***/ "./resources/js/ventas/ConfirmaSelecCliente.js":
/*!*****************************************************!*\
  !*** ./resources/js/ventas/ConfirmaSelecCliente.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ConfirmaSelecCliente)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
 ...
 * 
 */
var ConfirmaSelecCliente = /*#__PURE__*/function () {
  function ConfirmaSelecCliente(inputPagoContado) {
    _classCallCheck(this, ConfirmaSelecCliente);
  ...
  _createClass(ConfirmaSelecCliente, [{
    key: "inicio",
    value: function inicio() {
      ...
      var clienteSel = _VENTA.data_clie.nombre + " - " + _VENTA.data_clie.localidad;
    ...
    key: "_limpiarDatosModal",
    value: function _limpiarDatosModal() {
      var dir = document.querySelector('p#dataDir');
      dir.textContent = "Dirección:";
      var loc = document.querySelector('p#dataLoc');
      loc.textContent = "Localidad:";
      var select = document.querySelector('#selectModalCliente');
      select.value = 0;
    }
  }, {
    key: "_cambiarFormaPago",
    value: function _cambiarFormaPago() {
      var select = document.querySelector('#forma_pago_id');
      select.value = 4;
      select.disabled = true;
      _VENTA.forma_pago = 4;
    }
  }, {
    key: "_desHablitarPago",
    value: function _desHablitarPago() {
      var inputPago = document.querySelector('input#pagoContado');
      inputPago.setAttribute("disabled", "");
      this.lblFormaPago.innerText = 'A Cta. Cte.';
      var divVuelto = document.querySelector('#div-vuelto');
      divVuelto.classList.add('hidden');
    }
  }, {
    key: "_mostrarBotonBorrarClie",
    value: function _mostrarBotonBorrarClie() {
      var btnBuscarCli = document.querySelector('#btnBuscarCliente');
      btnBuscarCli.classList.add('hidden');
      var divBtnBorrarClie = document.querySelector('#divBtnBorrarClie');
      divBtnBorrarClie.classList.remove('hidden');
    }
  }, {
    key: "_totalCompEsTotalPago",
    value: function _totalCompEsTotalPago() {
      if (_VENTA.total > 0) {
        this.inputPago.typedValue = _VENTA.total;
        var inputVuelto = document.querySelector('#vuelto');
        inputVuelto.value = '';
      }
    }
  }]);

  return ConfirmaSelecCliente;
}();
...
/***/ "./resources/js/ventas/ConfirmaVenta.js":
/*!**********************************************!*\
  !*** ./resources/js/ventas/ConfirmaVenta.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "controlConfirmaVenta": () => (/* binding */ controlConfirmaVenta),
/* harmony export */   "default": () => (/* binding */ ConfirmaVenta),
/* harmony export */   "spinEspera": () => (/* binding */ spinEspera)
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/MensajeAlerta */ "./resources/js/utils/MensajeAlerta.js");
/* harmony import */ var _ImprimeTicketVenta__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ImprimeTicketVenta */ "./resources/js/ventas/ImprimeTicketVenta.js");
...
var ConfirmaVenta = /*#__PURE__*/function () {
  function ConfirmaVenta() {
    _classCallCheck(this, ConfirmaVenta);
  ...
  _createClass(ConfirmaVenta, [{
    key: "guardarDatosVenta",
    value: function guardarDatosVenta() {
      // store datos del comprobante
      this._storeComprobante().then(function (data) {
    ...
    key: "escondeModal",
    value: function escondeModal() {
      this.modal.classList.add('hidden'); //console.log('Datos comprobante:', this.comprobante);
    ...
    key: "_getNroComprobante",
    value: function () {
      var _getNroComprobante2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var parametro, resp;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                parametro = '?sucursal_id=' + this.comprobante.sucursal_id;
                _context.prev = 1;
                _context.next = 4;
                return axios(_VENTA.pathNroComprobante + parametro);

              case 4:
                resp = _context.sent;
                return _context.abrupt("return", resp.data.numero);
      ...
      function _getNroComprobante() {
        return _getNroComprobante2.apply(this, arguments);
      }

      return _getNroComprobante;
    }()
  }, {
    key: "_storeComprobante",
    value: function () {
      var _storeComprobante2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var _this = this;

        var respuest, nroComp, data;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                respuest = 'ok';
                _context2.next = 3;
                return this._getNroComprobante();

              case 3:
                nroComp = _context2.sent;
              ...
              case 9:
                (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se pudo obtener número de comprobante. \n\r', e);
              ...
              case 11:
                ...
                return axios({
                  ...
                  if (resp.data.estado == 'ok') {
                    ...
                    _VENTA.comprobante_id_guardado = resp.data.comprobante_id; //console.log('Comprobante id:', resp.data.comprobante_id);

                    //console.log('Comprobante id:', resp.data.comprobante_id);
                    _this._storeDetalleProductos(_VENTA.nro_comprobante, resp.data.comprobante_id).then(function (resp) {
                      if (resp === 'ok') {
                        // store productos de productos con receta
                        _this._storeDetalleProdsReceta().then(function (res) {
                          // store movimiento de caja
                          _this._storeDetalleCaja().then(function (res) {
                            var imprimeTicketVta = new _ImprimeTicketVenta__WEBPACK_IMPORTED_MODULE_3__["default"]();
                            imprimeTicketVta.inicio();
                            setTimeout(function () {
                              // Espero 3 segundos para recarga la pagina
                              location.reload();
                            }, 4000);
                          });
                        });
                    ...
                    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se pudo guardar el comprobante. \n\r', e);
                  }
                })["catch"](function (e) {
                  (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se pudo guardar el comprobante. \n\r', e);
                  respuest = 'error';
              ...
              case 14:
                return _context2.abrupt("return", respuest);
      ...
      function _storeComprobante() {
        return _storeComprobante2.apply(this, arguments);
      }

      return _storeComprobante;
    }()
  }, {
    key: "_storeDetalleProductos",
    value: function () {
      var _storeDetalleProductos2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(nro_comprob, comprob_id) {
        var data, resp;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                data = this._setDetalleVenta(nro_comprob, comprob_id);
                resp = 'ok'; //console.log('Detalle productos venta:', data);
                ...
                return axios({
                  ...
                  if (resp.data.estado == 'ok') {//console.log('Guardado detalle, ok!');
                  }
                })["catch"](function (e) {
                  (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se guardó detalle de comprobante. <br>', e);
                  resp = 'error';
                });
      ...
      function _storeDetalleProductos(_x, _x2) {
        return _storeDetalleProductos2.apply(this, arguments);
      }

      return _storeDetalleProductos;
    }()
  }, {
    key: "_storeDetalleProdsReceta",
    value: function () {
      var _storeDetalleProdsReceta2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
        var prodsConReceta, result;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                // comprobar si hay productos con receta...
                prodsConReceta = _VENTA.detalle.filter(function (elem) {
                  return elem.con_receta === 1;
                });
                result = 'error';
                ...
                return axios({
                  ...
                  (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se guardó detalle de receta.\n\r', e);
                });
      ...
      function _storeDetalleProdsReceta() {
        return _storeDetalleProdsReceta2.apply(this, arguments);
      }

      return _storeDetalleProdsReceta;
    }()
  }, {
    key: "_storeDetalleCaja",
    value: function () {
      var _storeDetalleCaja2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5() {
        var data, result;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                data = this._getDetalleCaja();
                result = 'error'; //console.log('Guardar movimiento de caja:', data);
                ...
                return axios({
                  ...
                  (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__.mensajeErrorEntendido)('No se guardó detalle de caja.\n\r', e);
                });
      ...
      function _storeDetalleCaja() {
        return _storeDetalleCaja2.apply(this, arguments);
      }

      return _storeDetalleCaja;
    }()
  }, {
    key: "_setDetalleVenta",
    value: function _setDetalleVenta(nro_comprobante, comprobante_id) {
      return _VENTA.detalle.map(function (elem) {
        delete elem.id;
    ...
    key: "_getDetalleCaja",
    value: function _getDetalleCaja() {
      ...
      _VENTA.detalle_caja.vuelto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(document.querySelector('#vuelto').value);
  ...
  return ConfirmaVenta;
}();



function controlConfirmaVenta() {
  var pago = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(document.querySelector('#pagoContado').value);
  var vuelto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(document.querySelector('#vuelto').value);
  var condicPago = parseInt(document.querySelector('#forma_pago_id').value);

  if (condicPago === 4) {
    // Si condicion de pago es Cta Cte pasa...
    return true;
  }

  if (vuelto < 0) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])("Importe de pago insuficiente!");
    document.querySelector('#pagoContado').focus();
    return false;
  }

  if (pago == 0) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])("Debe ingresar importe de pago !");
    document.querySelector('#pagoContado').focus();
    return false;
  }
...
function spinEspera() {
  var modalSpin = document.querySelector('.modal-espera');
...
/***/ "./resources/js/ventas/FormasPago.js":
/*!*******************************************!*\
  !*** ./resources/js/ventas/FormasPago.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FormasPago)
/* harmony export */ });
/* harmony import */ var _SelecCondicPago__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SelecCondicPago */ "./resources/js/ventas/SelecCondicPago.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var FormasPago = /*#__PURE__*/function () {
  function FormasPago(formaSelec, inputPagoContado, inputVuelto) {
    _classCallCheck(this, FormasPago);
    ...
    this.lblFormaPago = document.querySelector('#lblFormaPago'); // otras formas pago...
  }

  _createClass(FormasPago, [{
    key: "inicio",
    value: function inicio() {
      if (this.formaSelec != 4) {
        // Si no es Cta.Cte...first-letter:
        this._esconderDivs();
      }
      ...
      switch (this.formaSelec) {
        case 0:
          ...
          var selCondicPagoEf = new _SelecCondicPago__WEBPACK_IMPORTED_MODULE_0__["default"](1);
        ...
        case 4:
          ...
          var selCondicPagoCta = new _SelecCondicPago__WEBPACK_IMPORTED_MODULE_0__["default"](2);
      ...
      this._actualizarInputs(); // Actualizo forma de pago global
    ...
    key: "_esconderDivs",
    value: function _esconderDivs() {
      this.divVuelto.classList.add('hidden');
    }
  }, {
    key: "_mostrarVuelto",
    value: function _mostrarVuelto() {
      this.divVuelto.classList.remove('hidden');
    }
  }, {
    key: "_actualizarInputs",
    value: function _actualizarInputs() {
      if (_VENTA.total > 0) {
    ...
    key: "_deshabilitoInputPago",
    value: function _deshabilitoInputPago() {
      var inputPago = document.getElementById('pagoContado');
      inputPago.setAttribute("disabled", "");
    }
  }, {
    key: "_habilitoInputPago",
    value: function _habilitoInputPago() {
      var inputPago = document.getElementById('pagoContado');
...
/***/ "./resources/js/ventas/ImprimeTicketVenta.js":
/*!***************************************************!*\
  !*** ./resources/js/ventas/ImprimeTicketVenta.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ImprimeTicketVenta)
/* harmony export */ });
/* harmony import */ var _print_drvImpresion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../print/drvImpresion */ "./resources/js/print/drvImpresion.js");
/* harmony import */ var _utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/MensajeAlerta */ "./resources/js/utils/MensajeAlerta.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ImprimeTicketVenta = /*#__PURE__*/function () {
  function ImprimeTicketVenta() {
    _classCallCheck(this, ImprimeTicketVenta);
  }

  _createClass(ImprimeTicketVenta, [{
    key: "inicio",
    value: function inicio() {
    ...
    key: "_muestraPantallaImprimir",
    value: function _muestraPantallaImprimir() {
      if (_VENTA.impresora[0].nombre) {
        // SI HAY NOMBRE IMPRESORA IMPRIME DIRECTO
        var parametros = this._getParamsTicketVta();

        (0,_print_drvImpresion__WEBPACK_IMPORTED_MODULE_0__._drvImpresion)('ticket_vta', parametros).then(function (response) {
          //console.log('Impresion finalizada.', response);
          return response;
        })["catch"](function (error) {
          // handle error
          (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_1__["default"])('Error al imprimir !\n Intente mas tarde.');
        });
      } else {
        var url = _VENTA.pathImprimeTicket + '?id=' + _VENTA.comprobante_id_guardado;
    ...
    key: "_getParamsTicketVta",
    value: function _getParamsTicketVta() {
      return {
...
/***/ "./resources/js/ventas/ManejoPromo.js":
/*!********************************************!*\
  !*** ./resources/js/ventas/ManejoPromo.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ManejoPromo)
/* harmony export */ });
...
var __crearVentanaOpciones = function __crearVentanaOpciones(producto, opciones) {
  var comboActual = 1;

  var defH2 = __creaNombreProducto(producto),
  ...
  opciones.forEach(function (combo) {
    var defDiv = __creaDiv(),
...
var __creaDiv = function __creaDiv() {
  var div = document.createElement("div");
  div.classList.add('pl-1', 'mb-2');
  return div;
};

var __creaLabel = function __creaLabel() {
  var label = document.createElement("label");
  label.classList.add('block', 'pl-1', 'font-medium', 'text-sm', 'text-gray-700');
  return label;
};

var __creaSelect = function __creaSelect() {
...
var __creaNombreProducto = function __creaNombreProducto(prod) {
...
var __creaPrecioProducto = function __creaPrecioProducto(prod) {
  var precio = document.createElement("h3");
  precio.classList.add('p-1', 'font-medium', 'text-sm', 'text-center');
  precio.innerHTML = '$' + (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(prod.precio_vta, false, 2);
  return precio;
};

var ManejoPromo = /*#__PURE__*/function () {
  function ManejoPromo(promo) {
    _classCallCheck(this, ManejoPromo);
  ...
  _createClass(ManejoPromo, [{
    key: "selecPromo",
    value: function selecPromo() {
      ...
      var combos = this._dividirCombos(this.opcionesPromo); //console.log('Combos div:', combos);
    ...
    key: "_getOpcionesPromo",
    value: function _getOpcionesPromo(codigo) {
      return _VENTA.promo_opcs.filter(function (e) {
        return e.producto_codigo == codigo;
      });
    }
  }, {
    key: "_getProductoPromo",
    value: function _getProductoPromo(codigo) {
      var idx = _VENTA.productos.findIndex(function (e) {
        return e.producto_id == codigo;
      });
    ...
    key: "_dividirCombos",
    value: function _dividirCombos(opciones) {
      var combos = [],
          comboActual = 0;
...
/***/ "./resources/js/ventas/ManejoVenta.js":
/*!********************************************!*\
  !*** ./resources/js/ventas/ManejoVenta.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ManejoVenta)
/* harmony export */ });
/* harmony import */ var _UiLineaVenta__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UiLineaVenta */ "./resources/js/ventas/UiLineaVenta.js");
/* harmony import */ var _UiTotal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UiTotal */ "./resources/js/ventas/UiTotal.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ManejoVenta = /*#__PURE__*/function () {
  function ManejoVenta() {
    _classCallCheck(this, ManejoVenta);
  }

  _createClass(ManejoVenta, [{
    key: "productoSeleccionado",
    value: function productoSeleccionado(idProdSelec) {
      var promoOpcs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

      var idxVenta = _VENTA.detalle.findIndex(function (e) {
        return e.id == idProdSelec;
      });

      var uiTotal = new _UiTotal__WEBPACK_IMPORTED_MODULE_1__["default"]();
      var promoYaEstaEnLista = false;
      ...
      if (idxVenta == -1) {
        // el producto no está en lista venta
        var productoSelecc = this._buscarProducto(idProdSelec, promoOpcs);
    ...
    key: "opcionesPromo",
    value: function opcionesPromo(opciones) {
      var _this = this;

      // Ingresa opciones de promo a lista de venta
      opciones.forEach(function (elem) {
        var idOpcion = _this._buscarIdOpcionPromo(elem);

        var productoSelecc = _this._buscarOpcionPromo(idOpcion, opciones);

        _this._productoAListaVenta(productoSelecc);
      });
      return null;
    }
  }, {
    key: "opcionesPromoYaEnLista",
    value: function opcionesPromoYaEnLista(codsCombosSel) {
      var _this2 = this;

      codsCombosSel.forEach(function (elem) {
        var idOpcion = _this2._buscarIdOpcionPromo(elem);

        var productoSelecc = _this2._buscarOpcionPromo(idOpcion, codsCombosSel);

        var idxVenta = _VENTA.detalle.findIndex(function (e) {
          return e.id == idOpcion;
        });

        if (idxVenta == -1) {
          // el producto no está en lista venta
          _this2._productoAListaVenta(productoSelecc);
        } else {
          _this2._productoYaEnListaVenta(idOpcion, true);
        }
      });
      return null;
    }
    ...
    key: "_buscarProducto",
    value: function _buscarProducto(idProdSel) {
      var promoOpciones = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

      // Formato de tabla 'detalle_comprob_venta'
      var idx = _VENTA.productos.findIndex(function (e) {
        return e.id == idProdSel;
      });
    ...
    key: "_buscarOpcionPromo",
    value: function _buscarOpcionPromo(idProdSel) {
      var promoOpciones = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      ...
      var idxOpc = _VENTA.promo_opcs.findIndex(function (e) {
        return e.producto_codigo_opcion == _VENTA.productos[idx].codigo;
      });

      var strOpcionesPromo = '';
    ...
    key: "_buscarIdOpcionPromo",
    value: function _buscarIdOpcionPromo(codigo) {
      var idx = _VENTA.productos.findIndex(function (e) {
    ...
    key: "_productoAListaVenta",
    value: function _productoAListaVenta(producto) {
      _VENTA.detalle.push(producto); // Producto a lista de venta (array)


      var uiTablaVenta = new UiTablaVenta(); // Cargo a tabla Venta

      uiTablaVenta.insertaLinea(producto);
      return null;
    }
  }, {
    key: "_productoYaEnListaVenta",
    value: function _productoYaEnListaVenta(idProd) {
      var esPromo = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

      var idx = _VENTA.detalle.findIndex(function (e) {
        return e.id == idProd;
      });

      var producto = _VENTA.detalle[idx];

      var idxOpc = _VENTA.promo_opcs.findIndex(function (e) {
        return e.producto_codigo_opcion == producto.codigo;
      });
      ...
      var uiTablaVenta = new UiTablaVenta(); // Actualizar vista lista venta
...
var UiTablaVenta = /*#__PURE__*/function () {
  function UiTablaVenta() {
    _classCallCheck(this, UiTablaVenta);

    this.bodyTabla = document.querySelector('#bodyVenta');
    this.uiLineaVenta = new _UiLineaVenta__WEBPACK_IMPORTED_MODULE_0__["default"](this.bodyTabla);
  }

  _createClass(UiTablaVenta, [{
    key: "insertaLinea",
    value: function insertaLinea(prod) {
    ...
    value: function actualizarLista() {
      ...
      _VENTA.detalle.forEach(function (prod) {
        _this3.uiLineaVenta.productoALinea(prod);
      });
...
/***/ "./resources/js/ventas/ModalFinalVenta.js":
/*!************************************************!*\
  !*** ./resources/js/ventas/ModalFinalVenta.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ModalFinalVenta)
/* harmony export */ });
/* harmony import */ var _UiLineaVenta__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UiLineaVenta */ "./resources/js/ventas/UiLineaVenta.js");
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
...
var ModalFinalVenta = /*#__PURE__*/function () {
  function ModalFinalVenta() {
    _classCallCheck(this, ModalFinalVenta);

    this.modal = document.querySelector('.modal');
  }

  _createClass(ModalFinalVenta, [{
    key: "setDatos",
    value: function setDatos() {
      // Carga datos en modal
      var horaActual = new Date().toLocaleTimeString('en-GB', {
        hour: "numeric",
        minute: "numeric"
      });
      var fecha = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_2__.englishToSpanish)(_VENTA.fecha);
    ...
    key: "_getNombreCliente",
    value: function _getNombreCliente() {
    ...
    key: "_getNroComprobante",
    value: function _getNroComprobante() {
      var numero = document.querySelector('#nro_comprobante_completo').value;
      return "Ticket ".concat(numero);
    }
  }, {
    key: "_llenarBodyTablaVenta",
    value: function _llenarBodyTablaVenta() {
      // lista de productos de la venta
      var uiLinea = new _UiLineaVenta__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector('#bodyVentaModal'));
      uiLinea.resetBody();
    ...
    key: "_formatFecha",
    value: function _formatFecha(fecha) {
    ...
    key: "_importesPagoVueltoTotal",
    value: function _importesPagoVueltoTotal() {
      document.querySelector('#pagoModal').textContent = 'Pago $ ' + (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToCurrency)(document.querySelector('#pagoContado').value);
      document.querySelector('#vueltoModal').textContent = 'Vuelto $ ' + (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToCurrency)(document.querySelector('#vuelto').value);
      document.querySelector('#totalModal').textContent = 'Total $ ' + (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToCurrency)(_VENTA.total);
      return null;
    }
  }, {
    key: "_getFormaPago",
    value: function _getFormaPago() {
      var formaPago = '';
...
/***/ "./resources/js/ventas/PagoVueltoTotal.js":
/*!************************************************!*\
  !*** ./resources/js/ventas/PagoVueltoTotal.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PagoVueltoTotal)
/* harmony export */ });
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var PagoVueltoTotal = /*#__PURE__*/function () {
  function PagoVueltoTotal() {
    _classCallCheck(this, PagoVueltoTotal);

    this.inputVuelto = document.querySelector('#vuelto');
    this.inputPago = document.querySelector('#pagoContado');
  }

  _createClass(PagoVueltoTotal, [{
    key: "ingresoPago",
    value: function ingresoPago(valor) {
      var importe = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToFloat)(valor);

      if (valor === '' || _VENTA.total === 0) {
        this.inputVuelto.value = '';
        return null;
      } else if (importe < _VENTA.total) {
        this.inputVuelto.value = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(importe - _VENTA.total);
        this.inputVuelto.classList.add('text-red-500');
        this.inputPago.classList.add('text-red-500');
        return null;
      } else if (function (importe) {
        return _VENTA.total;
      }) {
        var vuelto = importe - _VENTA.total;
        this.inputVuelto.value = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(vuelto);
    ...
    key: "actualizoVuelto",
    value: function actualizoVuelto(total) {
      var pago = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToFloat)(this.inputPago.value);

      if (_VENTA.forma_pago > 0) {
        // Si forma pago no es contado
        this.inputVuelto.value = "";
      ...
      if (pago < total) {
        // Pongo el importe en rojo
        this.inputVuelto.value = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(pago - total);
        this.inputVuelto.classList.add('text-red-500');
        this.inputPago.classList.add('text-red-500');
      } else {
        this.inputVuelto.value = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(pago - total);
...
/***/ "./resources/js/ventas/SelecCondicPago.js":
/*!************************************************!*\
  !*** ./resources/js/ventas/SelecCondicPago.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SelecCondicPago)
/* harmony export */ });
/* harmony import */ var _utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/MensajeAlerta */ "./resources/js/utils/MensajeAlerta.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var SelecCondicPago = /*#__PURE__*/function () {
  function SelecCondicPago(condicPago) {
    _classCallCheck(this, SelecCondicPago);
  ...
  _createClass(SelecCondicPago, [{
    key: "deshabilitaBotones",
    value: function deshabilitaBotones() {
    ...
    key: "accionesSegunCondicion",
    value: function accionesSegunCondicion() {
      var inputCliente = document.querySelector('input#cliente');
      var divBtnBorrarClie = document.querySelector('#divBtnBorrarClie');

      if (this.condicPago === 2 && _VENTA.cliente_id === 0) {
        (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_0__["default"])("Debe seleccionar un cliente !");
      ...
      if (this.condicPago === 1 && _VENTA.cliente_id > 0) {
        (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_0__["default"])("Había seleccionado un cliente de cta. cte !");
        _VENTA.cliente_id = 0;
...
/***/ "./resources/js/ventas/SeleccionarCajaNro.js":
/*!***************************************************!*\
  !*** ./resources/js/ventas/SeleccionarCajaNro.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var SeleccionarCajaNro = /*#__PURE__*/function () {
  function SeleccionarCajaNro(cajasSuc) {
    _classCallCheck(this, SeleccionarCajaNro);

    this.cajasSuc = cajasSuc;
  }

  _createClass(SeleccionarCajaNro, [{
    key: "muestraAlert",
    value: function muestraAlert() {
    ...
    key: "muestraEnPant",
    value: function muestraEnPant(caja_nro) {
      var newText = _VENTA.sucursal_nombre + ' - Caja Nro. ' + caja_nro;
      var pTexto = document.querySelector('#suc_cajaNro');
    ...
    key: "_dosCajas",
    value: function () {
      var _dosCajas2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  ...
                  var newText = _VENTA.sucursal_nombre + ' - Caja Nro. ' + _VENTA.caja_nro;
                  var pTexto = document.querySelector('#suc_cajaNro');
                  pTexto.innerHTML = newText;
                });
      ...
      function _dosCajas() {
        return _dosCajas2.apply(this, arguments);
      }
    ...
    key: "_tresCajas",
    value: function _tresCajas() {}
  }]);

  return SeleccionarCajaNro;
}();

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SeleccionarCajaNro);

/***/ }),

/***/ "./resources/js/ventas/UiLineaVenta.js":
/*!*********************************************!*\
  !*** ./resources/js/ventas/UiLineaVenta.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UiLineaVenta)
/* harmony export */ });
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _UiTotal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UiTotal */ "./resources/js/ventas/UiTotal.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var _clickEnLineaVenta = function _clickEnLineaVenta(e) {
  ...
  var idprod = elem.dataset.idprod;
  ...
  if (producto.cantidad == 1) {
    ...
    if (producto.promo_opciones) {
      // Si tiene opciones, es promo y hay que borrar las opciones
      console.log('Producto a borrar:', producto);
      var arrCodigosOpcs = producto.promo_opciones.split(' ');
      arrCodigosOpcs.forEach(function (elem) {
        var indx = _VENTA.detalle.findIndex(function (e) {
          return e.codigo == elem;
        });
  ...
  var uiLinea = new UiLineaVenta(document.querySelector('#bodyVenta'));
  uiLinea.resetBody();
  ...
  var uiTotal = new _UiTotal__WEBPACK_IMPORTED_MODULE_1__["default"](); // Actualizo el total
...
var UiLineaVenta = /*#__PURE__*/function () {
  function UiLineaVenta(bodyTabla) {
    _classCallCheck(this, UiLineaVenta);

    this.bodyTabla = bodyTabla;
  }

  _createClass(UiLineaVenta, [{
    key: "resetBody",
    ...
    key: "productoALinea",
    value: function productoALinea(data) {
      var _this = this;

      var esModal = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var orden = ["descripcion", "precio", "cantidad", "total", "trash"];
      var esTrashModal = false,
          esOpcionPromo = false;
      ...
      orden.forEach(function (e) {
        ...
        switch (e) {
          ...
          case "precio":
            ...
            td.textContent = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(data.precio_unitario);
            break;
          ...
          case "total":
            td.classList.add("text-right", "py-1", "pr-1");
            td.textContent = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(data.subtotal);
            break;

          case "trash":
            if (!esModal) {
              td = _this._creaBotonTrash(td, esModal, data.id);
            } else {
              esTrashModal = true;
    ...
    key: "_creaSvgTrash",
    value: function _creaSvgTrash() {
      var svg = "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-5 w-5\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"rgba(239, 68, 68, 0.8)\" stroke-width=\"2\">\n        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16\" />\n    </svg>";
      return svg;
    }
  }]);
...
/***/ "./resources/js/ventas/UiListaProds.js":
/*!*********************************************!*\
  !*** ./resources/js/ventas/UiListaProds.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _ManejoVenta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ManejoVenta */ "./resources/js/ventas/ManejoVenta.js");
/* harmony import */ var _ManejoPromo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ManejoPromo */ "./resources/js/ventas/ManejoPromo.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var __checkPromo = function __checkPromo(idProd) {
  var idxProd = _VENTA.productos.findIndex(function (e) {
    return e.id == idProd;
  });

  var prod = _VENTA.productos[idxProd];

  var idx = _VENTA.promos.findIndex(function (e) {
    return e.producto_codigo == prod.codigo;
  });
...
var UiListaProds = /*#__PURE__*/function () {
  function UiListaProds(productos) {
    _classCallCheck(this, UiListaProds);

    this.productos = productos;
    this.bodyProductos = document.querySelector('#bodyProductos');
  }

  _createClass(UiListaProds, [{
    key: "productosALinea",
    value: function productosALinea(grupoId) {
      var intGrupoId = parseInt(grupoId.substring(3));
      var prods = this.productos.filter(function (el) {
        return el.grupo_id === intGrupoId;
      });
    ...
    key: "_vaciarBody",
    value: function _vaciarBody() {
      this.bodyProductos.innerHTML = "";
      return null;
    }
  }, {
    key: "_loopProds",
    value: function _loopProds(prods) {
      var estaClase = this; // ACA FILTRAR SI ES PROMO Y ESTA VIGENTE (EN LA LISTA DE PROMOS)

      prods.forEach(function (elem) {
        if (estaClase._checkPromoVigente(elem)) {
          return;
        }

        var tr = estaClase._setLinea(elem);

        estaClase.bodyProductos.appendChild(tr);
      });
    }
  }, {
    key: "_checkPromoVigente",
    value: function _checkPromoVigente(elem) {
      if (elem.grupo_id === 17) {
        // Si es grupo promo...
    ...
    key: "_checkCodigoEnPromo",
    value: function _checkCodigoEnPromo(codigo) {
      var idx = _VENTA.promos.findIndex(function (el) {
        return el.producto_codigo === codigo;
      });
    ...
    value: function _setLinea(data) {
      ...
      tdPrecio.textContent = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(data.precio_vta);
      tr.appendChild(tdDesc);
      tr.appendChild(tdPrecio);
      return tr;
    }
  }, {
    key: "_clickEnLineaProd",
    value: function _clickEnLineaProd() {
      // Click en línea producto
      var lineaProd = document.querySelectorAll('#bodyProductos > tr'); // Loop para dar evento click a cada linea de producto

      lineaProd.forEach(function (item) {
        item.addEventListener('click', function (e) {
          var elem = e.target.parentElement,
              promo = __checkPromo(elem.dataset.idprod);

          if (promo) {
            var manejoPromo = new _ManejoPromo__WEBPACK_IMPORTED_MODULE_2__["default"](promo);
            manejoPromo.selecPromo();
          } else {
            var manejoVta = new _ManejoVenta__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UiListaProds);

/***/ }),

/***/ "./resources/js/ventas/UiTotal.js":
/*!****************************************!*\
  !*** ./resources/js/ventas/UiTotal.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UiTotal)
/* harmony export */ });
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _PagoVueltoTotal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PagoVueltoTotal */ "./resources/js/ventas/PagoVueltoTotal.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var UiTotal = /*#__PURE__*/function () {
  function UiTotal() {
    _classCallCheck(this, UiTotal);
  }

  _createClass(UiTotal, [{
    key: "setTotal",
    value: function setTotal() {
      var pTotal = document.querySelector('#total');
      pTotal.textContent = "Total $ " + (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(this.calculoTotal());
    }
  }, {
    key: "calculoTotal",
    value: function calculoTotal() {
      ...
      _VENTA.total = total;
      var pagoVueltoTotal = new _PagoVueltoTotal__WEBPACK_IMPORTED_MODULE_1__["default"]();
      pagoVueltoTotal.actualizoVuelto(total); //return total.toFixed(2);
...
/***/ "./resources/js/ventas/accionesBtnBorrarCli.js":
/*!*****************************************************!*\
  !*** ./resources/js/ventas/accionesBtnBorrarCli.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var _accionesBtnBorrarCli = function _accionesBtnBorrarCli() {
  _VENTA.cliente_id = 0;
  var inputCliente = document.querySelector('input#cliente');
  inputCliente.value = "Consumidor final";
  ...
  var selFormasPago = document.querySelector('#forma_pago_id');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_accionesBtnBorrarCli);

/***/ }),

/***/ "./resources/js/ventas/confirmaPromoSeleccionada.js":
/*!**********************************************************!*\
  !*** ./resources/js/ventas/confirmaPromoSeleccionada.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "_confirmaPromoSeleccionada": () => (/* binding */ _confirmaPromoSeleccionada)
/* harmony export */ });
/* harmony import */ var _ManejoVenta__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ManejoVenta */ "./resources/js/ventas/ManejoVenta.js");
/**
 * 
...
var _confirmaPromoSeleccionada = function _confirmaPromoSeleccionada() {
  var codigosComboSelec = __getArrayCodigosCombosSelec();

  var manejoVta = new _ManejoVenta__WEBPACK_IMPORTED_MODULE_0__["default"]();
  var promoYaEstaEnLista = false; //console.log('Array opciones combos:', codigosComboSelec)
...
var __getArrayCodigosCombosSelec = function __getArrayCodigosCombosSelec() {
  var codigosCombos = [];

  for (var index = 1; index < _VENTA.promo_cant_combos + 1; index++) {
    var valor = document.querySelector('#selCombo-' + index).value;
...
/***/ "./resources/js/ventas/detalleDeCaja.js":
/*!**********************************************!*\
  !*** ./resources/js/ventas/detalleDeCaja.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (detalleDeCaja);

/***/ }),

/***/ "./resources/js/ventas/setBotonesDeModales.js":
/*!****************************************************!*\
  !*** ./resources/js/ventas/setBotonesDeModales.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var _setBotonesDeModales = function _setBotonesDeModales() {
  var closeModalVta = document.querySelectorAll('.close-modal');
  var closeModal2 = document.querySelectorAll('.close-modal-2');
  var closeModalPromo = document.querySelectorAll('.close-modal-promo');
  closeModalVta.forEach(function (close) {
    close.addEventListener('click', function (e) {
      document.querySelector('.modal').classList.add('hidden');
    });
  });
  closeModal2.forEach(function (close) {
    close.addEventListener('click', function () {
      document.querySelector('.modal-2').classList.add('hidden');
    });
  });
  closeModalPromo.forEach(function (close) {
    close.addEventListener('click', function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_setBotonesDeModales);
...
/*!**************************************!*\
  ...
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _SeleccionarCajaNro__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SeleccionarCajaNro */ "./resources/js/ventas/SeleccionarCajaNro.js");
/* harmony import */ var _PagoVueltoTotal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PagoVueltoTotal */ "./resources/js/ventas/PagoVueltoTotal.js");
/* harmony import */ var _ModalFinalVenta__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ModalFinalVenta */ "./resources/js/ventas/ModalFinalVenta.js");
/* harmony import */ var _UiListaProds__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UiListaProds */ "./resources/js/ventas/UiListaProds.js");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
/* harmony import */ var _utils_masks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/masks */ "./resources/js/utils/masks.js");
/* harmony import */ var _BuscarCliente__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./BuscarCliente */ "./resources/js/ventas/BuscarCliente.js");
/* harmony import */ var _ConfirmaSelecCliente__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ConfirmaSelecCliente */ "./resources/js/ventas/ConfirmaSelecCliente.js");
/* harmony import */ var _FormasPago__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FormasPago */ "./resources/js/ventas/FormasPago.js");
/* harmony import */ var _ConfirmaVenta__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ConfirmaVenta */ "./resources/js/ventas/ConfirmaVenta.js");
/* harmony import */ var _accionesBtnBorrarCli__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./accionesBtnBorrarCli */ "./resources/js/ventas/accionesBtnBorrarCli.js");
/* harmony import */ var _setBotonesDeModales__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./setBotonesDeModales */ "./resources/js/ventas/setBotonesDeModales.js");
/* harmony import */ var _confirmaPromoSeleccionada__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./confirmaPromoSeleccionada */ "./resources/js/ventas/confirmaPromoSeleccionada.js");
/* harmony import */ var _detalleDeCaja__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./detalleDeCaja */ "./resources/js/ventas/detalleDeCaja.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
/**
...
_VENTA.productos = _VENTA.productos.map(function (el) {
...
_VENTA.detalle_caja = _detalleDeCaja__WEBPACK_IMPORTED_MODULE_13__["default"];

_VENTA.cambiaColoresBtns = function (target, grupoBtns) {
  // Cambia color al boton actual
  target.classList.add('btnSelected2'); // Boton desactivo btn anterior

  grupoBtns.forEach(function (el) {
...
window.onload = function () {
  _VENTA.fecha = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_14__.fechaActual)('en');
  document.querySelector('#fecha_comprobante').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_14__.englishToSpanish)(_VENTA.fecha);
  document.querySelector('#cliente').value = 'Consumidor final'; // Set input cliente

  _VENTA.inputPagoContado = (0,imask__WEBPACK_IMPORTED_MODULE_4__["default"])(document.getElementById('pagoContado'), _utils_masks__WEBPACK_IMPORTED_MODULE_5__["default"].currency);
  _VENTA.inputPagoContado.typedValue = ''; // Set vuelto en 0

  var _inputVuelto = document.querySelector('#vuelto');

  _inputVuelto.value = ''; // Set select Forma de pago

  document.querySelector('#forma_pago_id').value = 0; // Set botones de modales

  (0,_setBotonesDeModales__WEBPACK_IMPORTED_MODULE_11__["default"])();

  if (_VENTA.caja_nro === 0) {
    var selCaja = new _SeleccionarCajaNro__WEBPACK_IMPORTED_MODULE_0__["default"](_VENTA.cajas_suc);
  ...
  _VENTA.btnGrupo_activo = 'ID_' + _VENTA.grupos[0].id; // Evento click en botones de grupos

  var _btnsGroups = document.querySelectorAll('.btnGrupos');

  _btnsGroups.forEach(function (elem) {
    var uiListaProds = new _UiListaProds__WEBPACK_IMPORTED_MODULE_3__["default"](_VENTA.productos); // Activo si es el primer elemento de grupos
  ...
  var inputPagoContado = document.querySelector('#pagoContado');
  inputPagoContado.addEventListener('keyup', function (e) {
    var valor = e.target.value;
    var pagoVueltoTotal = new _PagoVueltoTotal__WEBPACK_IMPORTED_MODULE_1__["default"]();
    pagoVueltoTotal.ingresoPago(valor);
  }); // Click en boton Confirma Venta

  var btnConfVenta = document.querySelector('#btnConfirmaVenta');
  btnConfVenta.addEventListener('click', function (e) {
    if ((0,_ConfirmaVenta__WEBPACK_IMPORTED_MODULE_9__.controlConfirmaVenta)()) {
      // Muestra modal para confirmar
      var modalFinalVenta = new _ModalFinalVenta__WEBPACK_IMPORTED_MODULE_2__["default"]();
      modalFinalVenta.setDatos();
      modalFinalVenta.muestraModal();
    }
  }); // Click en boton imprime ticket de venta

  var btnConfirmaTicket = document.querySelector('#btnConfirmaTicketVenta');
  btnConfirmaTicket.addEventListener('click', function (e) {
    var confirmaVenta = new _ConfirmaVenta__WEBPACK_IMPORTED_MODULE_9__["default"]();
    confirmaVenta.escondeModal();
    confirmaVenta.guardarDatosVenta();
  }); // Click en boton Buscar cliente

  var btnBuscarCliente = document.querySelector('#btnBuscarCliente');
  btnBuscarCliente.addEventListener('click', function (e) {
    e.preventDefault(); //const mostrarBuscarCliente = new MostrarBuscarCliente();
  ...
  var selectModalCliente = document.querySelector('#selectModalCliente');
  selectModalCliente.addEventListener('change', function (e) {
    var idClieSel = e.target.value;
    var buscarCli = new _BuscarCliente__WEBPACK_IMPORTED_MODULE_6__["default"](idClieSel); // Muestra datos del cliente en modal

    buscarCli.buscarMostrar();
  }); // Click boton Confirma selección de cliente

  var btnConfirmaClie = document.querySelector('#btnConfirmaModalClie');
  btnConfirmaClie.addEventListener('click', function (e) {
    e.preventDefault();
    var confirmaSelecClie = new _ConfirmaSelecCliente__WEBPACK_IMPORTED_MODULE_7__["default"](_VENTA.inputPagoContado);
    confirmaSelecClie.inicio();
  }); // Change combo Forma de pago

  var selFormaPago = document.querySelector('select#forma_pago_id');
  selFormaPago.addEventListener('change', function (e) {
    var pagoSelec = e.target.value;
    var formasPago = new _FormasPago__WEBPACK_IMPORTED_MODULE_8__["default"](pagoSelec, _VENTA.inputPagoContado, _inputVuelto);
    formasPago.inicio();
  }); // Click boton borrar cliente

  var btnBorrarCli = document.getElementById('btnBorrarClie');
  btnBorrarCli.addEventListener('click', function (e) {
    e.preventDefault();

    (0,_accionesBtnBorrarCli__WEBPACK_IMPORTED_MODULE_10__["default"])();
  }); // Click boton confirmar promocion

  var btnConfirmaPromo = document.getElementById('btnConfirmModalPromo');
  btnConfirmaPromo.addEventListener('click', function (e) {
    e.preventDefault();

    (0,_confirmaPromoSeleccionada__WEBPACK_IMPORTED_MODULE_12__._confirmaPromoSeleccionada)();
  });
};
})();
