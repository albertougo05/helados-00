...
"use strict";
/*!******************************************!*\
  !*** ./resources/js/ventas/mix/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
var _getDataUrl = function _getDataUrl() {
  var desde = "".concat(fechaDesde.value, " ").concat(inputHoraDesde.value);
  var hasta = "".concat(fechaHasta.value, " ").concat(inputHoraHasta.value);
  return "?desde=".concat(desde, "&hasta=").concat(hasta);
}; //
...
window.onload = function () {
  ...
  btnGenerarInfo.addEventListener('click', function (e) {
    if (_dataIsOk()) {
      var url = _pathDataMix + _getDataUrl(); //console.log('Datos:', data);
