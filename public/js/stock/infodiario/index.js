...
"use strict";
/*!************************************************!*\
  !*** ./resources/js/stock/infodiario/index.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
...
var _convertFecha = function _convertFecha(fecha) {
  var arr = fecha.split('-');
  return arr[2] + '-' + arr[1] + '-' + arr[0];
};

var _getParamsInfo = function _getParamsInfo(hora) {
  return {
...
var _showSpinImprime = function _showSpinImprime(show) {
  var spinImp = document.querySelector('#spinImprime');
...
window.onload = function () {
  // Inicializar form
  var inputHora = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('hora_toma_stock'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].hora);
  inputHora.typedValue = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_2__.horaActual)();
  document.getElementById('fecha_toma_stock').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_2__.fechaActual)('en');
  var btnImprimir = document.querySelector('#btnImprimir');
  btnImprimir.addEventListener('click', function (e) {
    if (_INFO_DIARIO._nombreImpresora) {
      // SI HAY NOMBRE IMPRESORA IMPRIME DIRECTO
      e.target.disabled = true;

      _showSpinImprime(true);

      (0,_print_drvImpresion__WEBPACK_IMPORTED_MODULE_3__._drvImpresion)('info_diario', _getParamsInfo(inputHora.value)).then(function (response) {
