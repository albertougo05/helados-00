...
/***/ "./resources/js/ctasctes/UiCtaCte.js":
/*!*******************************************!*\
  !*** ./resources/js/ctasctes/UiCtaCte.js ***!
  \*******************************************/
...
var UiCtaCte = /*#__PURE__*/function () {
  function UiCtaCte() {
    _classCallCheck(this, UiCtaCte);

    this.bodyDataTable = document.querySelector('#bodyDataCtaCte');
    this.total = 0;
  }

  _createClass(UiCtaCte, [{
    key: "llenarTabla",
    value: function llenarTabla(data) {
      this._vaciarBody();
    ...
    value: function _setLinea(data) {
      ...
      tdImport.textContent = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(data.importe);
    ...
    key: "_setTotal",
    value: function _setTotal() {
      var spTotal = document.querySelector('#spTotal');
      spTotal.textContent = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToCurrency)(this.total);
      return null;
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UiCtaCte);
...
"use strict";
/*!****************************************!*\
  !*** ./resources/js/ctasctes/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
...
/* harmony import */ var _UiCtaCte__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UiCtaCte */ "./resources/js/ctasctes/UiCtaCte.js");
...
window.onload = function () {
  document.getElementById('fecha_hasta').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_1__.fechaActual)('en');
  document.getElementById('fecha_desde').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_1__._sumaRestaFecha)('', '-', 30);
  var btnGenerarInfo = document.querySelector('#btnGenerarInfo');
  btnGenerarInfo.addEventListener('click', function (elem) {
    var selCliente = document.querySelector('#cliente').value;

    if (selCliente === "0") {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('No hay cliente selecionado !!');
      document.querySelector('#cliente').focus();
      return null;
    }

    var buscaCtaCte = _getDataCtaCte(selCliente);

    buscaCtaCte.then(function (data) {
      if (data.length > 0) {
        var dataCtacte = _getDatosOk(data);

        var uiTabla = new _UiCtaCte__WEBPACK_IMPORTED_MODULE_3__["default"]();
        uiTabla.llenarTabla(dataCtacte);
      } else (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('Sin movimientos !!');
    });
  });
};

var _getDataCtaCte = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(firma_id) {
    var config, res;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            config = _getConfigAxios(firma_id);
            _context.next = 3;
            return axios.get(_CTASCTES._pathDataCtaCte, config);
  ...
  return function _getDataCtaCte(_x) {
    return _ref.apply(this, arguments);
  };
}();

var _getConfigAxios = function _getConfigAxios(id) {
  return {
    method: 'GET',
    params: {
      firma_id: id,
...
var _getDatosOk = function _getDatosOk(data) {
  return data.map(function (elem) {
    elem.importe = parseFloat(elem.importe);
    elem.hora = elem.fecha_hora.substring(11, 16); // 2023-11-01 12:00 

    elem.fecha_registro = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_1__.englishToSpanish)(elem.fecha_registro);
    return elem;
  });
};
})();
