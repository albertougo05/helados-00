...
/***/ "./resources/js/turnos/InitEditForm.js":
/*!*********************************************!*\
  !*** ./resources/js/turnos/InitEditForm.js ***!
  \*********************************************/
...
/* harmony export */   "default": () => (/* binding */ InitEditForm)
/* harmony export */ });
...
var InitEditForm = /*#__PURE__*/function () {
  function InitEditForm() {
    _classCallCheck(this, InitEditForm);
  ...
  _createClass(InitEditForm, [{
    ...
    key: "_setInputs",
    value: function _setInputs() {
      this.inputs = {
        SaldoInic: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('saldo_inicio'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency),
        HoraCierre: document.getElementById('cierre_hora'),
        TarjCred: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('tarjeta_credito'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency),
        TarjDebi: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('tarjeta_debito'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency),
        CtaCte: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('cuenta_corriente'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency),
        Otros: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('otros'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency),
        Arqueo: (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('arqueo'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency) //Total: IMask(document.getElementById('venta_total'), masks.currency),
...
"use strict";
/*!*************************************!*\
  !*** ./resources/js/turnos/edit.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _formatMinutos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formatMinutos */ "./resources/js/turnos/formatMinutos.js");
/* harmony import */ var _InitEditForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./InitEditForm */ "./resources/js/turnos/InitEditForm.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
...
TURNO._initTablaBilletes = function () {
  TURNO._billetes.forEach(function (elem) {
...
TURNO._actualizarHora = function (_inp) {
  var _hora = new Date();

  _inp.HoraCierre.value = _hora.getHours() + ':' + (0,_formatMinutos__WEBPACK_IMPORTED_MODULE_1__["default"])(_hora.getMinutes());
  return null;
};

TURNO._actualizarInputsHidden = function () {
  var inpDifer = document.querySelector("[name='diferencia']");

  var difer = TURNO._sumaBilletes() - TURNO._totales['caja_teorica'];

  inpDifer.value = difer.toFixed(2);
  var cierreFechaHora = document.querySelector("[name='cierre_fecha_hora']");
  var hora = document.querySelector("#cierre_hora");
  cierreFechaHora.value = TURNO._fecha_actual + ' ' + hora.value;
  return null;
}; // Obtiene los inputs


var _init = new _InitEditForm__WEBPACK_IMPORTED_MODULE_2__["default"]();

TURNO._inputs = _init.getInputs();

var _actualizarFechaCierreTurno = function _actualizarFechaCierreTurno() {
  var inputFechaHora = document.querySelector("[name='cierre_fecha_hora']");
  inputFechaHora.value = _formatCierreFechaHora();
  return null;
};

var _formatCierreFechaHora = function _formatCierreFechaHora() {
  //const fecha = document.querySelector('#cierre_fecha').value;
  var fecha = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__.fechaActual)('en');
  var hora = document.querySelector('#cierre_hora').value;
  return fecha + ' ' + hora;
};

window.onload = function () {
  console.log('Caja teorica:', TURNO._totales.caja_teorica); // Enter y flecha abajo baja en inputs - Flecha arriba, sube foco en inputs numericos
  ...
  document.addEventListener('keydown', function (ev) {
    ...
    if ((ev.key === "Enter" || ev.key === "ArrowDown" || ev.key === "ArrowUp") && ev.target.nodeName === 'INPUT') {
      ...
      var focusableElementsString = 'input:not([readonly])';
      var ol = document.querySelectorAll(focusableElementsString);
      var o = {};
  ...
  document.getElementById('cierre_fecha').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__.fechaActual)('es'); // Set hora actual del navegador

  TURNO._actualizarHora(TURNO._inputs); // Armo tabla (array) para contar billetes


  TURNO._initTablaBilletes(); // Evento click boton Confirma cierre de caja


  var btnConfirma = document.querySelector('#btnConfirma');
  btnConfirma.addEventListener('click', /*#__PURE__*/function () {
...
TURNO._formatCurrency = function (value) {
  var options = {
    style: 'currency',
    currency: 'EUR'
  };
  var numberFormat = new Intl.NumberFormat('de-DE', options);
...
TURNO._sumaBilletes = function () {
  ...
  TURNO._tablaBilletes.forEach(function (elem) {
...
TURNO._sumoTotales = function (suma) {
  var total = suma;
  ...
  total += parseFloat(TURNO._totales['transfer']); //total += parseFloat(TURNO._totales['ingresos']);
  // Resto los egresos
...
TURNO._actualizoInputs = function (suma) {
...
TURNO._onkeyUpBilletes = function (elem) {
  var cantidad = parseInt(elem.value);
  var nombre = elem.id;
  var id_bill = parseInt(nombre.slice(5));

  var idx = TURNO._billetes.findIndex(function (x) {
    return x.id == id_bill;
  });

  var div_tot = document.querySelector('#tot-' + id_bill);

  if (cantidad) {
    // Solo si existe un valor en cantidad
    var importe = TURNO._billetes[idx].importe;
