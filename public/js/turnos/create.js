...
/***/ "./resources/js/turnos/checkDataForm.js":
/*!**********************************************!*\
  !*** ./resources/js/turnos/checkDataForm.js ***!
  \**********************************************/
...
/* harmony export */ });
var checkDataForm = function checkDataForm(hora, saldo) {
  var data = {
    result: false,
    message: '',
    input: ''
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (checkDataForm);
...
/* harmony import */ var _checkDataForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkDataForm */ "./resources/js/turnos/checkDataForm.js");
/* harmony import */ var _formatMinutos__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./formatMinutos */ "./resources/js/turnos/formatMinutos.js");
...
var inputHoraApertura = document.getElementById('apertura_hora');
var inputSaldoInic = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('saldo_inicio'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency);
document.getElementById('apertura_fecha').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__.fechaActual)('es');
document.querySelector('#empleado').value = TURNO._usuario_nombre;
inputSaldoInic.typedValue = TURNO._saldo_inicio;

var _hora = new Date();

inputHoraApertura.value = (0,_formatMinutos__WEBPACK_IMPORTED_MODULE_4__["default"])(_hora.getHours()) + ':' + (0,_formatMinutos__WEBPACK_IMPORTED_MODULE_4__["default"])(_hora.getMinutes()); // Change en select caja número

var selectCajaNro = document.querySelector('#caja_nro');
selectCajaNro.addEventListener('change', /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cajaSel = e.target.value;
            url = "".concat(TURNO._pathBuscarArqueo, "?suc_id=").concat(TURNO._sucursal_id);
            url += '&caja_nro=' + cajaSel; // Buscar el arqueo del número de caja seleccionada
          ...
          case 10:
            ...
            (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('No se encontró arqueo caja anterior !');
...
btnConfirma.addEventListener('click', function (e) {
  e.preventDefault();
  var checkData = (0,_checkDataForm__WEBPACK_IMPORTED_MODULE_3__["default"])(inputHoraApertura.value, inputSaldoInic.value);

  if (checkData.result) {
    var hora = document.querySelector('#apertura_hora').value;
    document.querySelector('#apertura_fecha_hora').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__.fechaActual)('en') + ' ' + hora;
    document.querySelector('#caja').value = document.querySelector('#saldo_inicio').value;
    e.target.disabled = true;
    document.querySelector('#formTurno').submit();
  } else {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])(checkData.message);
