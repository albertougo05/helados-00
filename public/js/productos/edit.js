...
/***/ "./resources/js/productos/Promocion.js":
/*!*********************************************!*\
  !*** ./resources/js/productos/Promocion.js ***!
  \*********************************************/
...
var __colores = ['0', //  Indice 0 sin color
'bg-orange-200', 'bg-blue-200', 'bg-teal-200', 'bg-yellow-200', 'bg-indigo-200', 'bg-red-200'];

var __cambiaClaseColor = function __cambiaClaseColor(elem, idx) {
  for (var index = 1; index < __colores.length; index++) {
...
var __spinGuardando = function __spinGuardando(show) {
  var spinGuardando = document.querySelector('#spinGuardandoPromo');
...
var __getFechaHora = function __getFechaHora(cuando) {
  var fecha = '',
      hora = '',
      fechaHora = '';
...
var Promocion = /*#__PURE__*/function () {
  function Promocion() {
    _classCallCheck(this, Promocion);
  ...
  _createClass(Promocion, [{
    key: "cargaArticOpciones",
    value: function cargaArticOpciones() {
      if (_promocion_opciones.length > 0) {// Opciones a la tabla en pantalla
    ...
    key: "setNuevoArtic",
    value: function setNuevoArtic(combo, codigo, precio, cant) {
      var selArtic = document.querySelector('#selArtPromo');
      var descrip = selArtic.options[selArtic.selectedIndex].text;

      var opcArtic = _objectSpread({}, _PROMO._modeloArtOpcion);
      ...
      _PROMO._opciones.push(opcArtic); // Ordenar por nro de combo


      _PROMO._opciones.sort(function (a, b) {
        return a.nro_combo > b.nro_combo ? 1 : -1;
      });

      return null;
    }
  }, {
    key: "nuevoArticuloATabla",
    value: function nuevoArticuloATabla() {
      var prod = _PROMO._opciones[_PROMO._opciones.length - 1];
      var tableBoby = document.querySelector('#bodyTablePromo'); // Armo la línea

      var linea = this.__armoLinea(prod);

      tableBoby.appendChild(linea); //this.__actualizoTotalPromo();
    }
  }, {
    key: "getListaArticulosToStore",
    value: function getListaArticulosToStore() {
      return _PROMO._opciones.map(function (e) {
        delete e.id;
        delete e.subtotal;
        return e;
      });
    ...
    key: "setProductoEditado",
    value: function setProductoEditado(combo, idProd, precio, cant) {
      var idx = _PROMO._opciones.findIndex(function (e) {
        return e.producto_codigo_opcion == idProd;
      });

      console.log('Combo:', combo, 'Codigo prod:', idProd, 'Indice:', idx);
      _PROMO._opciones[idx].nro_combo = parseInt(combo); //_PROMO._opciones[idx].costo = this.__stringToNumber(costo);

      _PROMO._opciones[idx].precio = this.__stringToNumber(precio);
      _PROMO._opciones[idx].cantidad = this.__stringToNumber(cant);
      _PROMO._opciones[idx].subtotal = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__._roundToTwo)(this.__stringToNumber(cant) * this.__stringToNumber(precio));
    }
  }, {
    key: "redibujaTabla",
    value: function redibujaTabla() {
      var _this = this;

      var tableBoby = document.querySelector('#bodyTablePromo');
      tableBoby.innerHTML = "";

      _PROMO._opciones.forEach(function (prod) {
        if (prod.estado === 1) {
          var linea = _this.__armoLinea(prod);
    ...
    key: "getArticuloEnLista",
    value: function getArticuloEnLista(idprod) {
      var idx = _PROMO._opciones.findIndex(function (e) {
        return e.producto_codigo_opcion == idprod;
      });
    ...
    key: "eliminaArticuloDePromo",
    value: function eliminaArticuloDePromo(idprod) {
      if (_promocion_producto) {
        // Si producto tiene promocion...
        var idx = _PROMO._opciones.findIndex(function (e) {
          return e.producto_codigo_opcion == idprod;
        });
        ...
        // Si no tiene elimina del array
        _PROMO._opciones = _PROMO._opciones.filter(function (e) {
          return e.producto_codigo_opcion != idprod;
        });
      }
    ...
    key: "cambiarClaseColor",
    value: function cambiarClaseColor(elem, idx) {
    ...
    key: "salvarDatos",
    value: function salvarDatos() {
      __spinGuardando(true);

      this.__setProductoPromo();

      Promise.all([this._updateDatosProductoPromo(), this._updateDatosArticulosOpc()]).then(function (results) {
        var producto = results[0],
            articulos = results[1]; //console.log('Resultados:', producto.data.status, articulos.data.status);

        if (producto.data.status == 'error' || articulos.data.status == 'error') {
          (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_1__["default"])('Error salvando datos promoción !', 'error');
        } else {
          (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_1__["default"])('Promoción guardada con exito !', 'success');
          setTimeout(function () {
    ...
    value: function __armoLinea(prod) {
      ...
      Object.entries(prod).forEach(function (_ref) {
        ...
        switch (key) {
          ...
          case 'nro_combo':
            ...
            td.classList.add('text-center'); //td.textContent = this.__numberFormat(value);
          ...
          case 'cantidad':
            ...
            td.textContent = _this2.__numberFormat(value, 3);
            break;

          case 'precio':
            td.classList.add('text-right', 'pr-1');
            td.textContent = _this2.__numberFormat(value);
            break;

          case 'subtotal':
            td.classList.add('text-right', 'pr-2');
            td.textContent = _this2.__numberFormat(value, 2);
            break;
        }
    ...
    key: "__numberFormat",
    value: function __numberFormat(num) {
    ...
    key: "__stringToNumber",
    value: function __stringToNumber(str) {
      var num = str;
    ...
    key: "__onClickTr",
    value: function __onClickTr(e) {
      // codigo sale del segundo elemento de la linea
      var codigo = e.target.parentElement.cells[1].textContent;

      var idx = _PROMO._opciones.findIndex(function (e) {
        return e.producto_codigo_opcion == codigo;
      });

      var modal = document.querySelector('#modalArticuloPromo');
      var btnElimina = document.querySelector('button#btnEliminaArtPromo');
      var titulo = document.querySelector('h2#tituloModalPromo');
      var selArtPromo = document.querySelector('#selArtPromo');
      var selComboPromo = document.querySelector('#selComboPromo');
      var divPromo = document.querySelector('#divPromo');
    ...
    key: "__setProductoPromo",
    value: function __setProductoPromo() {
      ...
      _PROMO._producto_promocion.precio_vta = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_0__.strToFloat)(document.getElementById('precioPromo').value);
      return null;
    }
  }, {
    key: "__getDiasSemana",
    value: function __getDiasSemana() {
      var arrDiasPromo = [],
          dias_promo = document.getElementsByName('dias_promo');

      var _iterator = _createForOfIteratorHelper(dias_promo),
          _step;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Promocion);

/***/ }),

/***/ "./resources/js/productos/Receta.js":
/*!******************************************!*\
  !*** ./resources/js/productos/Receta.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Receta = /*#__PURE__*/function () {
  function Receta() {
    _classCallCheck(this, Receta);
  ...
  _createClass(Receta, [{
    key: "cargaProductos",
    value: function cargaProductos(prods) {
      var _this = this;

      if (prods.length > 0) {
        _productosReceta = [];
        prods = prods.forEach(function (prod) {
          var subtotal = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__._roundToTwo)(prod.cantidad * prod.costo);
          ...
          _productosReceta.push(temp); // Sub-producto a la tabla en pantalla


          _this.nuevoProductoATabla();
        });
      }
    } // Agrega producto desde modal
    ...
    key: "setNuevoProd",
    value: function setNuevoProd(idprodrecet, cant, costo) {
      //console.log('Costo:', costo, 'Tipo:', typeof costo);
      var idx = _productos_receta.findIndex(function (e) {
        return e.codigo == idprodrecet;
      });

      var cantidad = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(cant);
      var costoProd = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(costo);

      var subtotal = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__._roundToTwo)(cantidad * costoProd);
    ...
    key: "nuevoProductoATabla",
    value: function nuevoProductoATabla() {
      var prod = _productosReceta[_productosReceta.length - 1];
      var tableBoby = document.querySelector('#bodyTableReceta'); // Armo la línea
    ...
    key: "getListaProductosToStore",
    value: function getListaProductosToStore() {
      return _productosReceta.map(function (e) {
        delete e.subtotal;
        return e;
      });
    }
    ...
    key: "setProductoEdit",
    value: function setProductoEdit(idProd, costo, cant) {
      var idx = _productosReceta.findIndex(function (e) {
        return e.producto_receta_id == idProd;
      }); //console.log('Idx:', idx, 'productosReceta:', _productosReceta);


      _productosReceta[idx].costo = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(costo);
      _productosReceta[idx].cantidad = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(cant);
      _productosReceta[idx].subtotal = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__._roundToTwo)((0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(cant) * (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_1__.strToFloat)(costo));
    }
  }, {
    key: "redibujaTabla",
    value: function redibujaTabla() {
      ...
      var tableBoby = document.querySelector('#bodyTableReceta');
      tableBoby.innerHTML = "";

      _productosReceta.forEach(function (prod) {
        var linea = _this2.__armoLinea(prod);
    ...
    key: "checkProdEnLista",
    value: function checkProdEnLista(idprod) {
      var indice = true;
    ...
    key: "getProductoEnLista",
    value: function getProductoEnLista(idprod) {
      var idx = _productosReceta.findIndex(function (e) {
        return e.producto_receta_id == idprod;
      });
    ...
    key: "eliminaProductoDeReceta",
    value: function eliminaProductoDeReceta(idprod) {
      _productosReceta = _productosReceta.filter(function (e) {
        return e.producto_receta_id != idprod;
      });
    }
  }, {
    key: "eliminaProdDeDB",
    value: function () {
      var _eliminaProdDeDB = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(idprod) {
        var response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios('/producto_receta/elimina/' + idprod);
      ...
      function eliminaProdDeDB(_x) {
        return _eliminaProdDeDB.apply(this, arguments);
      }

      return eliminaProdDeDB;
    }()
    /**   FUNCIONES PRIVADAS   **/
    // Armo linea para tabla Receta (un producto)
    ...
    value: function __armoLinea(prod) {
      ...
      Object.entries(prod).forEach(function (_ref) {
        ...
        switch (key) {
          ...
          case 'costo':
            td.classList.add('text-right', 'pr-1');
            td.textContent = _this3.__numberFormat(value);
            break;

          case 'cantidad':
            td.classList.add('text-right', 'pr-1');
            td.textContent = _this3.__numberFormat(value, 3);
            break;

          case 'subtotal':
            td.classList.add('text-right', 'pr-2');
            td.textContent = _this3.__numberFormat(value, 2);
            break;
        }
    ...
    key: "__actualizoTotalReceta",
    value: function __actualizoTotalReceta() {
      var _this4 = this;

      this.totalReceta = 0;

      _productosReceta.forEach(function (prod) {
        _this4.totalReceta += prod.subtotal;
      }); // Actualizo la pantalla
    ...
    value: function __onClickTr(e) {
      ...
      var codigo = e.target.parentElement.cells[0].textContent;

      var idx = _productosReceta.findIndex(function (e) {
        return e.producto_receta_id == codigo;
      });

      var modal = document.querySelector('.modalReceta');
      var btnElimina = document.querySelector('button#btnEliminaProdReceta');
      var titulo = document.querySelector('h2#tituloModal');
      var selProdReceta = document.querySelector('#selProductoReceta'); //console.log('Codigo:', codigo, 'Producto:', _productosReceta[idx]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Receta);

/***/ }),

/***/ "./resources/js/productos/init-form.js":
/*!*********************************************!*\
  !*** ./resources/js/productos/init-form.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "disparaTabPromo": () => (/* binding */ disparaTabPromo),
/* harmony export */   "disparaTabReceta": () => (/* binding */ disparaTabReceta),
/* harmony export */   "eventosDelForm": () => (/* binding */ eventosDelForm),
/* harmony export */   "inputsConMask": () => (/* binding */ inputsConMask)
/* harmony export */ });
/* harmony import */ var _mostrarImagen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mostrarImagen */ "./resources/js/productos/mostrarImagen.js");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
/* harmony import */ var _utils_masks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/masks */ "./resources/js/utils/masks.js");
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _tabSucursales__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tabSucursales */ "./resources/js/productos/tabSucursales.js");
/* harmony import */ var _utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/MensajeAlerta */ "./resources/js/utils/MensajeAlerta.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
/**
...
var inputsConMask = {
  inputPrecio1: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('precio_lista_1'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency),
  inputPrecio2: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('precio_lista_2'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency),
  inputPrecio3: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('precio_lista_3'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency),
  inputCostoUnid: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('costo_x_unidad'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency),
  inputCostoBulto: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('costo_x_bulto'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency),
  inputPesoMP: (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('peso_materia_prima'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].tresDecimales)
}; //
// Dispara evento si selecciona receta (export)
//

var disparaTabReceta = function disparaTabReceta() {
  _activaTabCompra(false);

  _activaTabPromo(false);

  var tabReceta = document.querySelector('#tabReceta');
...
var eventosDelForm = function eventosDelForm(form) {
  if (form === 'edit') {
    var inputUltAct = document.getElementById('ultima_actualizacion');
    inputUltAct.value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__.englishToSpanish)(_producto.ultima_actualizacion);
    _inputModalCosto = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('modalCosto'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency);
    _inputModalCantidad = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('modalCantidad'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].tresDecimales);
    _PROMO._inputPrecioPromo = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('precioPromo'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency);
    _PROMO._inputModalPromoPrecio = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('precioArtPromo'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].currency);
    _PROMO._inputModalPromoCantidad = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('cantArtPromo'), _utils_masks__WEBPACK_IMPORTED_MODULE_2__["default"].tresDecimales); // Al salir input costo promocion ...

    var inpCostoPromo = document.querySelector('#precioPromo');
    inpCostoPromo.addEventListener('blur', function (e) {
      var costoPromo = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(e.target.value); // Actualizar inputs de precios de lista
  ...
  document.getElementById('imagen').onchange = _mostrarImagen__WEBPACK_IMPORTED_MODULE_0__.mostrarImgCreate; // Seleccionar tipo Elaborado, selecciona Receta, y pone readonly opciones Apto receta y Genérico

  var selTipoProd = document.querySelector('#tipo_producto_id');
  ...
  var selGrupoProd = document.querySelector('#grupo_id');
  ...
  _tabSucursales__WEBPACK_IMPORTED_MODULE_4__["default"].inicio(_producto_sucurs); // Evento CLICK boton Confirma form

  var btnConfirma = document.querySelector('#btnConfirma');
  btnConfirma.addEventListener('click', function (e) {
    var form = document.querySelector('form');
    e.preventDefault(); // Ver si están datos mínimos...
    ...
    if (_tabSucursales__WEBPACK_IMPORTED_MODULE_4__["default"].getSucursalSelec) {
      // Si hay sucursales selecionada...
      // Salvar datos sucs
      _tabSucursales__WEBPACK_IMPORTED_MODULE_4__["default"].salvarDatos().then(function (data) {
        if (data.estado === 'ok') {
          form.submit();
        }
      });
  ...
  var btnBorrarImg = document.querySelector('#btnBorrarImg');
  btnBorrarImg.addEventListener('click', function (e) {
    e.preventDefault();
    var divImg = document.getElementById('divImagen');
    divImg.classList.add('hidden');
    var divInputImg = document.querySelector('#divInputImagen');
    divInputImg.classList.remove('hidden');
    document.querySelector('input#imagen').value = null; //document.querySelector('input#nombre_imagen').value = '';
  }); // Mascara de solo ingreso de número en input 

  document.getElementById('unidades_x_caja').onkeyup = _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.soloNumeros;
  document.getElementById('cajas_x_bulto').onkeyup = _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.soloNumeros;
  document.getElementById('unidades_x_bulto').onkeyup = _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.soloNumeros; // Evento 'change' del select de producto de articulo individual

  document.getElementById('selArticuloIndiv').onchange = _onchangeSelectArticuloIndiv; // Al salir de descripcion completa input ticket  - ALFAJOR  BLANCO CAJA

  var inputDescrip = document.querySelector("input#descripcion");
  inputDescrip.addEventListener("blur", function (e) {
    var desc = e.target.value;
    var ticket = document.querySelector('input#descripcion_ticket');
    desc = desc.slice(0, 20);
    ticket.value = desc;
  }); // Al salir de costo por bulto, ...

  var inpCostoBulto = document.querySelector('#costo_x_bulto');
  inpCostoBulto.addEventListener('blur', function (e) {
    var costoBulto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(e.target.value);
    var unidPorBulto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.getElementById('unidades_x_bulto').value);

    if (unidPorBulto !== 0) {
      inputsConMask.inputCostoUnid.typedValue = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__._roundToTwo)(costoBulto / unidPorBulto);
    }

    return null;
  }); // Al salir (blur) de inputs unid. por caja y cajas por bulto

  var inpUnidPorCaja = document.querySelector('#unidades_x_caja');
  var inpCajasPorBulto = document.querySelector('#cajas_x_bulto');
  inpUnidPorCaja.addEventListener('blur', _blurUnidCajaUnidBulto);
  inpCajasPorBulto.addEventListener('blur', _blurUnidCajaUnidBulto); // Al salir de input unidades por bulto...

  var inpUnidPorBulto = document.querySelector('#unidades_x_bulto');
  inpUnidPorBulto.addEventListener('blur', function (e) {
    var unidPorBulto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(e.target.value);
    var costoPorBulto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.getElementById('costo_x_bulto').value);

    if (costoPorBulto !== 0) {
      inputsConMask.inputCostoUnid.typedValue = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__._roundToTwo)(costoPorBulto / unidPorBulto);
    }

    return null;
  }); // Click en checkbox Promo todos

  var ckbTodos = document.querySelector("input#promo_todos");
  ckbTodos.addEventListener("click", function (e) {
    var valor = e.target.value; //const checkboxes = document.querySelectorAll('#dias_promo input[type="checkbox"]');

    var checkboxes = document.querySelectorAll('input[name="dias_promo"]');
  ...
  var ckbTodasSucs = document.querySelector("input#sucursalesTodas");
  ckbTodasSucs.addEventListener("click", function (e) {
    var valor = e.target.value;
    var checkboxes = document.querySelectorAll('input[name="sucursales[]"]');
  ...
  var cboFechaDesde = document.querySelector("input#promo_desde");
  cboFechaDesde.addEventListener('blur', function (e) {
    if (form === 'create') {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Debe confirmar producto, para cargar promoción !! !', 'error');
      return null;
    }

    if (!(0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__._validaFecha)((0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_6__.englishToSpanish)(e.target.value))) {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Ingrese fecha válida !', 'error');
      e.target.focus();
    }
  });
  var cboFechaHasta = document.querySelector("input#promo_hasta");
  cboFechaHasta.addEventListener('blur', function (e) {
    if (form === 'create') {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Debe confirmar producto, para cargar promoción !! !', 'error');
      return null;
    }
...
var _onchangeSelectArticuloIndiv = function _onchangeSelectArticuloIndiv(e) {
...
var _muestraSpinGuardando = function _muestraSpinGuardando() {
...
var _activaTabCompra = function _activaTabCompra(estado) {
  var tabCompra = document.querySelector('#tabDatosCompra');
...
var _activaTabReceta = function _activaTabReceta(estado) {
  var tabReceta = document.querySelector('#tabReceta');
...
var _activaTabPromo = function _activaTabPromo(estado) {
  var tabPromo = document.querySelector('#tabPromo');

  if (estado) {
    tabPromo.setAttribute('aria-disabled', 'false'); // activa tab promo

    tabPromo.classList.remove('isDisabled');
    var divPrecioPromo = document.querySelector('#divPrecioPromo');
...
var _checkDatosObligatorios = function _checkDatosObligatorios() {
  var resultado = false;
  var inpDescrip = document.querySelector('#descripcion'),
  ...
  if (inpDescrip.value.replace(/\s/g, "") == "") {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Ingrese una Descripción !', 'error');
    inpDescrip.focus();
  } else if (selTipoProd.value == 0) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Ingrese Tipo de Producto !', 'error');
    selTipoProd.focus();
  } else if (selTipoProd.value == 0) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Ingrese Grupo de Producto !', 'error');
    selGrupo.focus();
  } else if (selProveed.value == 0 && selTipoProd.value != 1 && selTipoProd.value != 4) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_5__["default"])('Ingrese un Proveedor !', 'error');
    selProveed.focus();
  } else resultado = true;
...
var _blurUnidCajaUnidBulto = function _blurUnidCajaUnidBulto(elem) {
  var unidCaja = Number.parseInt(document.querySelector('input#unidades_x_caja').value),
  ...
  document.querySelector('#unidades_x_bulto').value = unidPorBulto; //console.log('unid caja:', unidCaja, 'cajas por bulto:', cajasBulto, 'unid por bulto:', unidPorBulto);

  if (unidPorBulto !== 0) {
    var costoBulto = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.querySelector('#costo_x_bulto').value);
    inputsConMask.inputCostoUnid.typedValue = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__._roundToTwo)(costoBulto / unidPorBulto);
  }
...
var _eventoChangeSelecTipoProducto = function _eventoChangeSelecTipoProducto(value) {
  if (value == 1) {
    disparaTabReceta();
    ...
    // PROMOS
    disparaTabPromo();
    var selectGrupo = document.querySelector('#grupo_id');
...
var _eventoChangeSelectGrupo = function _eventoChangeSelectGrupo(value) {
  if (value == 17) {
    // Selecciona PROMO
    disparaTabPromo();
    var selectTipo = document.querySelector('#tipo_producto_id');
    selectTipo.value = 4;
    document.querySelector('#tabDatosCompra').href = '#tabs';
    document.querySelector('#apto_receta').disabled = false;
    document.querySelector('#generico').disabled = false;
...
var _disparaTabCompra = function _disparaTabCompra() {
  _activaTabCompra(true);
...
var disparaTabPromo = function disparaTabPromo() {
  var tabPromo = document.querySelector('#tabPromo');
  var clickEvent = new Event('click');
...
/***/ "./resources/js/productos/modalArtPromo.js":
/*!*************************************************!*\
  !*** ./resources/js/productos/modalArtPromo.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initModalPromo": () => (/* binding */ initModalPromo)
/* harmony export */ });
/* harmony import */ var _resetModalPromo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./resetModalPromo */ "./resources/js/productos/resetModalPromo.js");
...
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _Promocion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Promocion */ "./resources/js/productos/Promocion.js");
...
var promocion = new _Promocion__WEBPACK_IMPORTED_MODULE_4__["default"]();
promocion.cargaArticOpciones(); // Inicializa modal ingreso articulos de promocion

var initModalPromo = function initModalPromo() {
  if (_promocion_producto) {
  ...
  var modalPromo = document.querySelector('#modalArticuloPromo'),
      btnShowModalPromo = document.querySelector('#btnAgregarArticulo'),
      closeModalPromo = document.querySelectorAll('.close-modal-promo'),
      divPromo = document.querySelector('#divPromo'); // Evento boton agregar producto (muestra modal)

  btnShowModalPromo.addEventListener('click', function () {
    (0,_resetModalPromo__WEBPACK_IMPORTED_MODULE_0__["default"])(_PROMO._inputModalPromoPrecio, _PROMO._inputModalPromoCantidad);
  ...
  var selArticPromo = document.querySelector('#selArtPromo');
  selArticPromo.addEventListener('change', function (e) {
    var codigo = e.target.value; // Buscar en _productos_receta (aptos receta)

    var idx = _articulos_promo.findIndex(function (e) {
  ...
  var selCboPromo = document.querySelector('#selComboPromo');
  selCboPromo.addEventListener('change', function (e) {
    var valor = e.target.value; //const divPromo = document.querySelector('#divPromo');

    promocion.cambiarClaseColor(divPromo, valor);
  }); // Evento modal: boton confirma producto seleccionado

  var confirmaArticulo = document.querySelector('#btnConfirmaArtPromo');
  confirmaArticulo.addEventListener('click', function (e) {
    var combo = parseInt(document.querySelector('#selComboPromo').value),
        codigo = document.querySelector('#selArtPromo').value,
        cantidad = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.querySelector('#cantArtPromo').value),
        //costo = strToFloat(document.querySelector('#costoArtPromo').value),
    precio = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.querySelector('#precioArtPromo').value);
  ...
  var btnEliminaArt = document.querySelector('button#btnEliminaArtPromo');
  btnEliminaArt.addEventListener('click', function (e) {
    var selArtPromo = document.querySelector('#selArtPromo');
    var desc = selArtPromo.options[selArtPromo.selectedIndex].textContent; // La eliminacion sucede en esta función...

    alertaElimina(desc.trim(), _idArtEditado);
  }); // Evento 'click' boton "Confirma Promo" (para nuevo receta !)

  var btnConfirmaPromo = document.querySelector('#btnConfirmaPromo');
  ...
  var alertaElimina = function alertaElimina(prod, id) {
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      ...
      if (result.isConfirmed) {
        ...
        var _prod = promocion.getArticuloEnLista(id); // Eliminar de _productosReceta


        promocion.eliminaArticuloDePromo(id); // Recargar la Receta en tabla

        promocion.redibujaTabla(); // Cerrar el modal
...
var _validarArticulo = function _validarArticulo(codigo, cantidad, precio) {
  var campo = '';
  ...
  if (campo !== '') {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('Error, debe ingresar ' + campo, 'error');
    return false;
  }
...
var _estanTodosLosCampos = function _estanTodosLosCampos() {
  var estado = true,
      diasPromo = [],
      mjeError = '';
  var desde = document.querySelector('#promo_desde').value,
      hasta = document.querySelector('#promo_hasta').value,
      dias_promo = document.getElementsByName('dias_promo'),
      precioPromo = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_3__.strToFloat)(document.querySelector('#precioPromo').value);
  ...
  if (mjeError) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])(mjeError, 'error');
    estado = false;
  }
...
var _cargarInputsPromocion = function _cargarInputsPromocion() {
...
var _getFechaHora = function _getFechaHora(pide) {
  var dato = '';

  var arrDesde = _PROMO._producto_promocion.desde_fecha_hora.split(' '),
...
var _setDiasSemana = function _setDiasSemana() {
  var dias = _PROMO._producto_promocion.dias_semana.split(' ');
...
/***/ "./resources/js/productos/modalProdReceta.js":
/*!***************************************************!*\
  !*** ./resources/js/productos/modalProdReceta.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _resetModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resetModal */ "./resources/js/productos/resetModal.js");
/* harmony import */ var _Receta__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Receta */ "./resources/js/productos/Receta.js");
/* harmony import */ var _utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/MensajeAlerta */ "./resources/js/utils/MensajeAlerta.js");
...
var receta = new _Receta__WEBPACK_IMPORTED_MODULE_2__["default"]();
receta.cargaProductos(_productosReceta);

var modalProdReceta = function modalProdReceta() {
  // Modal ingreso Productos a Receta
  var modal = document.querySelector('.modalReceta'),
      showModal = document.querySelector('#btnAgregarProducto'),
      closeModal = document.querySelectorAll('.close-modal'); // Evento receta: boton agregar producto (muestra modal)

  showModal.addEventListener('click', function () {
    (0,_resetModal__WEBPACK_IMPORTED_MODULE_1__["default"])(_inputModalCosto, _inputModalCantidad);
    modal.classList.remove('hidden');
  }); // Evento modal: boton Cancela y X
  ...
  var selProdReceta = document.querySelector('#selProductoReceta');
  selProdReceta.addEventListener('change', function (e) {
    var codigo = e.target.value;

    if (receta.checkProdEnLista(codigo)) {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__["default"])('El producto ya está en la lista!');
      e.target.value = 0;
      e.target.focus();
      return null;
    }

    var costo = 0; // Buscar en _productos_receta (aptos receta)
  ...
  var confirmaModal = document.querySelector('#btnConfirmaModal');
  confirmaModal.addEventListener('click', function (e) {
    var codigo = document.querySelector('#selProductoReceta').value;
    var cantidad = document.querySelector('#modalCantidad').value;
    var costo = document.querySelector('#modalCosto').value;
  ...
  btnElimina.addEventListener('click', function (e) {
    var selProdReceta = document.querySelector('#selProductoReceta');
    var desc = selProdReceta.options[selProdReceta.selectedIndex].textContent; // La eliminacion sucede en esta función...

    alertaElimina(desc.trim(), _idProdEditado);
  }); // Evento 'click' boton "Confirma Receta" (para nuevo receta !)

  var btnConfirmaReceta = document.querySelector('#btnConfirmaReceta');
  btnConfirmaReceta.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
      var productosReceta, inputConReceta, configAxios, response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              productosReceta = receta.getListaProductosToStore();
              inputConReceta = document.querySelector('input#con_receta');
              configAxios = {
                method: 'POST',
                url: '/producto_receta',
            ...
            case 6:
              response = _context.sent;
              (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__["default"])('Receta guardada con éxito !', 'success');
              setTimeout(function () {
                var form = document.querySelector('form');
                form.submit();
              }, 4000); // if (inputConReceta.value === "0") {
            ...
            case 11:
              ...
              (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__["default"])('Error, no se pudo guardar receta! \n\r' + _context.t0);
  ...
  var alertaElimina = function alertaElimina(prod, id) {
    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
      ...
      if (result.isConfirmed) {
        var _modal = document.querySelector('.modalReceta');

        var _prod = receta.getProductoEnLista(id);

        if (_prod.id > 0) {
          // Si tiene id, eliminar de DB...
          receta.eliminaProdDeDB(_prod.id).then(function (data) {//console.log('Status:', data.data.status);
          });
        ...
        receta.redibujaTabla(); // Cerrar el modal
...
var _validaCamposReceta = function _validaCamposReceta(codigo, cantidad, costo) {
  var campo = '';
  ...
  if (campo !== '') {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__["default"])('Error, debe ingresar ' + campo);
    return false;
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (modalProdReceta);

/***/ }),

/***/ "./resources/js/productos/mostrarImagen.js":
/*!*************************************************!*\
  !*** ./resources/js/productos/mostrarImagen.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mostrarImgCreate": () => (/* binding */ mostrarImgCreate)
/* harmony export */ });
//
// productos/mostrarImagen.js
//
var mostrarImgCreate = function mostrarImgCreate() {
  var inputImg = document.querySelector('input#imagen');
...
/***/ "./resources/js/productos/resetModal.js":
/*!**********************************************!*\
  !*** ./resources/js/productos/resetModal.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 */
var resetModal = function resetModal(inputModalCosto, inputModalCantidad) {
  var selProd = document.querySelector('#selProductoReceta');
  var inpCant = document.querySelector('#modalCantidad');
  var titulo = document.querySelector('h2#tituloModal');
  var btnElimina = document.querySelector('button#btnEliminaProdReceta');
...
/***/ "./resources/js/productos/resetModalPromo.js":
/*!***************************************************!*\
  !*** ./resources/js/productos/resetModalPromo.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 * Reset inputs del modal
 */
var resetModalPromo = function resetModalPromo(inputModalPrecio, inputModalCantidad) {
  var selComboPromo = document.querySelector('#selComboPromo');
  var selArtPromo = document.querySelector('#selArtPromo');
  var inpCant = document.querySelector('#cantArtPromo');
  var btnElimina = document.querySelector('button#btnEliminaArtPromo');
  btnElimina.classList.add('hidden');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (resetModalPromo);

/***/ }),

/***/ "./resources/js/productos/tabSucursales.js":
/*!*************************************************!*\
  !*** ./resources/js/productos/tabSucursales.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var tabSucursales = function () {
  // private members
  var _arr_sucs_prods = [],
      // Lista final que se recoje al presionar boton salvar 
  // funciones publicadas en public members
  inicio = function inicio(sucurs_producto) {
    if (sucurs_producto.length == 0) return null;

    _setCheckBoxes(sucurs_producto);
  },
      getSucursalSelec = function getSucursalSelec() {
    var checkboxes = document.querySelectorAll('input[name="sucursales[]"]');
    ...
    return false; // NO HAY SUCURSAL SELECCIONADA
      ...
      salvarDatos = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var checkboxes, retorno, configAxios, i, response, _response;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              checkboxes = document.querySelectorAll('input[name="sucursales[]"]');
              retorno = {
                estado: 'error'
              }, configAxios = {};
              i = 0;
            ...
            case 3:
              ...
              configAxios = _setConfigAxios('post', checkboxes[i].value); //                        console.log('Store sucursal...', configAxios)
            ...
            case 14:
              ...
              // Si NO está tildado y tiene id de registro, BORRAR...
              configAxios = _setConfigAxios('delete', '0', checkboxes[i].dataset.idregsuc); //                        console.log('Delete sucursal...', configAxios)
   ...
   * 
   **/
  _setCheckBoxes = function _setCheckBoxes(sucs_prod) {
    var checkboxes = document.querySelectorAll('input[name="sucursales[]"]');

    var _loop = function _loop(i) {
      // Paso datos en DB a checkboxes
      var idx = sucs_prod.findIndex(function (el) {
        return el.sucursal_id === parseInt(checkboxes[i].value);
      });
    ...
    return sucs_prod;
      ...
      _setConfigAxios = function _setConfigAxios(metodo, sucId) {
    var idReg = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '0';
    var configAxios = {};
    ...
    switch (metodo) {
      ...
      case 'delete':
        configAxios = {
          method: 'GET',
          url: _pathBorrarSucursal.replace('/0', "/".concat(idReg))
        };
        break;
    }
    ...
    return configAxios;
      ...
      _alerta = function _alerta(mensaje, icon) {
    sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      position: 'center',
      icon: icon,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tabSucursales);
...
/*!****************************************!*\
  ...
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _init_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./init-form */ "./resources/js/productos/init-form.js");
/* harmony import */ var _modalProdReceta__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modalProdReceta */ "./resources/js/productos/modalProdReceta.js");
/* harmony import */ var _modalArtPromo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modalArtPromo */ "./resources/js/productos/modalArtPromo.js");
...
(0,_init_form__WEBPACK_IMPORTED_MODULE_0__.eventosDelForm)('edit'); // Init inputs

var inputs = _init_form__WEBPACK_IMPORTED_MODULE_0__.inputsConMask; // Valores para inputs

var inputPrecio1 = inputs.inputPrecio1;
inputPrecio1.typedValue = _producto.precio_lista_1;
var inputPrecio2 = inputs.inputPrecio2;
inputPrecio2.typedValue = _producto.precio_lista_2;
var inputPrecio3 = inputs.inputPrecio3;
inputPrecio3.typedValue = _producto.precio_lista_3;
var inputCostoUnid = inputs.inputCostoUnid;
inputCostoUnid.typedValue = _producto.costo_x_unidad;
var inputCostoBulto = inputs.inputCostoBulto;
inputCostoBulto.typedValue = _producto.costo_x_bulto;
var inputPesoMP = inputs.inputPesoMP;
inputPesoMP.typedValue = _producto.peso_materia_prima; // Inicializo modal receta

(0,_modalProdReceta__WEBPACK_IMPORTED_MODULE_1__["default"])();

if (_producto.tipo_producto_id == 4) {
  // Inicializo modal promociones
  (0,_modalArtPromo__WEBPACK_IMPORTED_MODULE_2__.initModalPromo)();
}
...
window.onload = function () {
  ...
  _productos_receta = _productos_receta.map(function (el) {
    el.costo_x_unidad = parseFloat(el.costo_x_unidad);
    return el;
  });
  _productosReceta = _productosReceta.map(function (el) {
    el.cantidad = parseFloat(el.cantidad);
    el.costo = parseFloat(el.costo);
    return el;
  });
  var tabCompra = document.querySelector('#tabDatosCompra');
  var tabVenta = document.querySelector('#tabDatosVenta');
  var tabPromo = document.querySelector('#tabPromo');
  var tabReceta = document.querySelector('#tabReceta'); // Si tipo_producto = elaborado, activa tab receta
  ...
  if (_producto.tipo_producto_id == 1) {
    ...
    (0,_init_form__WEBPACK_IMPORTED_MODULE_0__.disparaTabReceta)();
  }
  ...
  if (_producto.tipo_producto_id == 4) {
    ...
    (0,_init_form__WEBPACK_IMPORTED_MODULE_0__.disparaTabPromo)();
