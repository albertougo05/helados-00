...
window.onload = function () {
  // Set eventos
  (0,_init_form__WEBPACK_IMPORTED_MODULE_0__.eventosDelForm)("create"); // Init inputs

  var inputs = _init_form__WEBPACK_IMPORTED_MODULE_0__.inputsConMask; // Click en boton Agregar producto a Receta

  var btnAgregarProd = document.querySelector("#btnAgregarProducto");
  ...
  var btnAgregarArticulo = document.querySelector("#btnAgregarArticulo");
