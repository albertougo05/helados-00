...
"use strict";
/*!********************************************!*\
  !*** ./resources/js/caja/informe/index.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
var inputHoraDesde = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('hora_desde'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].hora),
    inputHoraHasta = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('hora_hasta'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].hora),
...
var _dataIsOk = function _dataIsOk() {
  var result = true;

  if (fechaDesde.value === '') {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('Fecha desde inválida !!', 'error');
    fechaDesde.focus();
    result = false;
  } else if (fechaHasta.value === '') {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('Fecha hasta inválida !!', 'error');
    fechaHasta.focus();
    result = false;
  }

  if (selTipoMov.value == 0 && selFormPago.value == 0) {
    (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_2__["default"])('Debe seleccionar movimiento !!', 'error');
    selTipoMov.focus();
    result = false;
  }
...
var _getDataUrl = function _getDataUrl() {
  var data = 'desde=' + fechaDesde.value + ' ' + inputHoraDesde.value;
...
window.onload = function () {
  ...
  inputHoraHasta.typedValue = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__.horaActual)();
  document.getElementById('fecha_hasta').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__.fechaActual)('en');
  document.getElementById('fecha_desde').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_3__._sumaRestaFecha)('', '-', 30);
  selTipoMov.addEventListener('change', function (e) {
    if (selFormPago.value !== '0') {
      selFormPago.value = '0';
    }
  });
  selFormPago.addEventListener('change', function (e) {
    if (selTipoMov.value !== '0') {
      selTipoMov.value = '0';
    }
  });
  btnGenerarInfo.addEventListener('click', function (e) {
    if (_dataIsOk()) {
      var data = _getDataUrl();

      var url = _INFORM._pathShowInfo + '?' + data; //console.log('Datos:', data);
