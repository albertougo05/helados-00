...
/***/ "./resources/js/caja/imprimeMovimCaja.js":
/*!***********************************************!*\
  !*** ./resources/js/caja/imprimeMovimCaja.js ***!
  \***********************************************/
...
/* harmony export */   "default": () => (/* binding */ imprimeMovimCaja)
/* harmony export */ });
...
var __formatFechaHora = function __formatFechaHora(fecha_or) {
  var arr1 = fecha_or.split(' ');
  var arr2 = arr1[0].split('-');
  return "".concat(arr2[2], "-").concat(arr2[1], "-").concat(arr2[0], " ").concat(arr1[1]);
};

var __getParams = function __getParams() {
  return {
...
function imprimeMovimCaja() {
  if (CAJA._nombreImpresora) {
    (0,_print_drvImpresion__WEBPACK_IMPORTED_MODULE_0__._drvImpresion)('movim_caja', __getParams()).then(function (response) {
      return null;
...
/* harmony import */ var _turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../turnos/formatMinutos */ "./resources/js/turnos/formatMinutos.js");
...
/* harmony import */ var _utils_solo_numeros__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/solo-numeros */ "./resources/js/utils/solo-numeros.js");
/* harmony import */ var _utils_transformFechas__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/transformFechas */ "./resources/js/utils/transformFechas.js");
/* harmony import */ var _imprimeMovimCaja_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./imprimeMovimCaja.js */ "./resources/js/caja/imprimeMovimCaja.js");
...
var _checkDataForm = function _checkDataForm(importe, selecTipo) {
  var data = {
    result: false,
    message: '',
    input: ''
...
function _changeTipoMovimSelec(ev) {
  var tipo_mov = ev.target.value;
  var id_tipo_movim = ev.target.options[ev.target.selectedIndex].dataset.idtipomovim;
  var importe = document.querySelector('#importe_1');
  var descrip = document.querySelector('#descrip_tipo_mov');
...
function _setFormParaSubmit(tipo_movim_selec) {
  var fecha = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_5__.spanishToEnglish)(document.querySelector('#fecha').value);
  var hora = document.querySelector('#hora').value;
  var importe = document.querySelector('#importe_1').value; // 5 - Ingreso / 4 - Egreso

  var text_concepto = tipo_movim_selec.options[tipo_movim_selec.selectedIndex].text;
  document.querySelector('#concepto').value = text_concepto;
  document.querySelector('#fecha_hora').value = fecha + ' ' + hora;
  document.querySelector('#importe').value = (0,_utils_solo_numeros__WEBPACK_IMPORTED_MODULE_4__.strToFloat)(importe);
  return null;
}
...
window.onload = function () {
  ...
  var inputImporte = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('importe_1'), _utils_masks__WEBPACK_IMPORTED_MODULE_1__["default"].currency);
  document.getElementById('fecha').value = CAJA._fecha_actual;
  document.getElementById('fecha_registro').value = (0,_utils_transformFechas__WEBPACK_IMPORTED_MODULE_5__.spanishToEnglish)(CAJA._fecha_actual);
  document.querySelector('#empleado').value = CAJA._usuario_nombre; // Si muestra status, lo quita a los 3 segundos...
  ...
  inputHora.value = (0,_turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_2__["default"])(_hora.getHours()) + ':' + (0,_turnos_formatMinutos__WEBPACK_IMPORTED_MODULE_2__["default"])(_hora.getMinutes()); // Change select tipo comprobante...

  var tipo_movim_selec = document.querySelector('#tipo_comprobante_id');
  tipo_movim_selec.addEventListener('change', _changeTipoMovimSelec); // Click boton confirmar (IMPRIME MOVIMIENTO !!)
  ...
  btnConfirma.addEventListener('click', function (e) {
    ...
    var checkData = _checkDataForm(inputImporte.value, tipo_movim_selec);

    if (checkData.result) {
      var spin = document.querySelector('#spinGuardando');
      spin.classList.remove('hidden');

      _setFormParaSubmit(tipo_movim_selec);

      (0,_imprimeMovimCaja_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
      document.querySelector('#formMovim').submit();
    } else {
      (0,_utils_MensajeAlerta__WEBPACK_IMPORTED_MODULE_3__["default"])(checkData.message);
