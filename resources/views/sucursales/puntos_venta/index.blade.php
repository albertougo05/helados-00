<x-app-layout>
    <x-slot name="title">Heladerías - Puntos Venta</x-slot>
        ...
        <div class="mx-auto w-full md:w-10/12 bg-gray-100 overflow-hidden shadow-lg sm:rounded-lg opacity-85">
            ...
            <div class="flex flex-col"">
                <div class="flex justify-end px-8">
                    <a href="{{ route('puntos_venta.create') }}" class="focus:outline-none text-white text-base py-1 px-5 rounded bg-green-500 hover:bg-green-600 hover:shadow-md flex items-center">
                    ...
                    <table class="min-w-full md:rounded-lg">
                        <thead class="bg-indigo-800 text-gray-200">
                            <tr>
                                ...
                                <th scope="col" class="px-2 py-2">Sucursal</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($puntosVta as $punto)
                                <tr class="hover:bg-gray-100">
                                    <td class="text-center">{{ $punto->id }}</td>
                                    <td>{{ $punto->nombre }}</td>
                                    <td class="truncate">{{ $punto->direccion }}</td>
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('puntos_venta.edit', $suc) }}" 
