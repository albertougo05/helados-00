<x-app-layout>
    <x-slot name="title">Heladerías - Tipos Mov. Caja</x-slot>
        ...
        <div class="mx-auto w-full md:w-10/12 bg-gray-100 overflow-hidden shadow-lg sm:rounded-lg opacity-85">
            ...
            <div class="flex flex-col"">
                <div class="flex justify-end px-8">
                    <a href="{{ route('caja_tipos_movim.create') }}" class="focus:outline-none text-white text-base py-1 px-5 rounded bg-green-500 hover:bg-green-600 hover:shadow-md flex items-center">
                            ...
                            @foreach ($tiposMov as $tipo)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="px-6 py-1 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('caja_tipos_movim.edit', $tipo->id) }}" 
